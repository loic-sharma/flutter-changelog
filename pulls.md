...
* **[Sarbagya Dhaubanjar](https://github.com/sarbagyastha)** &mdash; Respect `calendarDelegate` in `showDateRangePicker` and make `CalendarDateRangePicker` public<br />
  <sub>[#168290](https://github.com/flutter/flutter/pull/168290) opened on on May 4, 2025 &mdash; **Small:** [0 comments](https://github.com/flutter/flutter/pull/168290) 50 additions and 5 deletions in 2 files</sub><br />
