...
* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Adds githooks that reminds to run `gclient sync -D`
    <sub>[#51156](https://github.com/flutter/engine/pull/51156) merged on March 5, 2024 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/51156) over 1 day, 248 additions and 3 deletions in 10 files</sub>
    <sub>Reviewed by: [Loïc Sharma](https://github.com/loic-sharma), [Jason Simmons](https://github.com/jason-simmons)</sub>
