...
* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Pin `customer_testing` to the SHA specified in `tests.version`<br />
  ...
  <sub>Reviewed by: [Harri Kirik](https://github.com/harri35), [Greg Price](https://github.com/gnprice), [Zachary Anderson](https://github.com/zanderso), [John McDole](https://github.com/jtmcdole)</sub><br />
