...
* **[Tong Mu](https://github.com/dkwingsmt)** &mdash; Reland 2 (part 1): Enforce the rule of calling `FlutterView.Render`
    <sub>[#47062](https://github.com/flutter/engine/pull/47062) merged on October 18, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/47062) over 3 hours, 45 additions and 24 deletions in 2 files</sub>
    <sub>Reviewed by: [Loïc Sharma](https://github.com/loic-sharma)</sub>
