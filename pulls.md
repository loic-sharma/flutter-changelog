...
* **[Ben Konyi](https://github.com/bkonyi)** &mdash; Replace custom `RPCErrorCodes` with `RPCErrorKind` from `package:vm_service`<br />
  <sub>[#158379](https://github.com/flutter/flutter/pull/158379) opened on on November 8, 2024 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/158379) 71 additions and 95 deletions in 14 files</sub><br />
