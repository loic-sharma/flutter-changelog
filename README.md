...
* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Migrate `video_player/android` from `SurfaceTexture`->`SurfaceProducer`.<br />
    <sub>[#6456](https://github.com/flutter/packages/pull/6456) merged on May 29, 2024 &mdash; **Small:** [14 comments](https://github.com/flutter/packages/pull/6456) over 1 month, 136 additions and 38 deletions in 6 files</sub><br />
