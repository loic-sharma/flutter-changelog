...
* **[Justin McCandless](https://github.com/justinmc)** &mdash; Hide the context menu on tap down
    <sub>[#126295](https://github.com/flutter/flutter/pull/126295) merged on May 12, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/flutter/pull/126295) over 3 days, 97 additions and 3 deletions in 3 files</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog)</sub>
    <sub><details><summary>1 image...</summary>![context_menu_down](https://user-images.githubusercontent.com/389558/236940609-f4d70182-b1dd-4d88-b577-dfd37853c88b.gif)</details></sub>

* **[fzyzcjy](https://github.com/fzyzcjy)** &mdash; Tiny cleanup for Navigator code (without introducing dependency)
    <sub>[#125628](https://github.com/flutter/flutter/pull/125628) merged on May 8, 2023 &mdash; **Small:** [21 comments](https://github.com/flutter/flutter/pull/125628) over 1 week, 31 additions and 39 deletions in 1 file</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks), [chunhtai](https://github.com/chunhtai)</sub>

* **[Reid Baker](https://github.com/reidbaker)** &mdash; Test AGP 8.0 using java 17
    <sub>[#125323](https://github.com/flutter/flutter/pull/125323) merged on May 8, 2023 &mdash; **Large:** [14 comments](https://github.com/flutter/flutter/pull/125323) over 2 weeks, 464 additions and 332 deletions in 19 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>

* **[fzyzcjy](https://github.com/fzyzcjy)** &mdash; Fix that `flutter test` does not understand `concurrency`
    <sub>[#125942](https://github.com/flutter/flutter/pull/125942) merged on May 8, 2023 &mdash; **Small:** [21 comments](https://github.com/flutter/flutter/pull/125942) over 5 days, 7 additions and 7 deletions in 3 files</sub>
...
* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Increase test timeout for analyzer_benchmark to 60 minutes
    <sub>[#126586](https://github.com/flutter/flutter/pull/126586) merged on May 12, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/126586) over 20 hours, 1 addition and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>

* **[Michael Goderbauer](https://github.com/goderbauer)** &mdash; Make dpr available during Scrollable disposal
    <sub>[#126535](https://github.com/flutter/flutter/pull/126535) merged on May 11, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/126535) over 2 hours, 49 additions and 4 deletions in 4 files</sub>
...
* **[Casey Hillers](https://github.com/CaseyHillers)** &mdash; [github] Add labeler action
    <sub>[#126012](https://github.com/flutter/flutter/pull/126012) merged on May 9, 2023 &mdash; **Small:** [26 comments](https://github.com/flutter/flutter/pull/126012) over 5 days, 134 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Kevin Chisholm](https://github.com/itsjustkevin), [godofredoc](https://github.com/godofredoc), [keyonghan](https://github.com/keyonghan)</sub>

* **[Michael Goderbauer](https://github.com/goderbauer)** &mdash; Fix leaks
    <sub>[#126144](https://github.com/flutter/flutter/pull/126144) merged on May 8, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/126144) over 2 days, 115 additions and 75 deletions in 13 files</sub>
    <sub>Reviewed by: [Polina Cherkasova](https://github.com/polina-c)</sub>

* **[Elias Yishak](https://github.com/eliasyishak)** &mdash; Clearer text about what happens with `--disable-telemetry` + enable-telemetry command
    <sub>[#125995](https://github.com/flutter/flutter/pull/125995) merged on May 8, 2023 &mdash; **Small:** [13 comments](https://github.com/flutter/flutter/pull/125995) over 4 days, 110 additions and 20 deletions in 3 files</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog)</sub>
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix `showDatePicker` in input mode throws an `ArgumentError`
    <sub>[#126525](https://github.com/flutter/flutter/pull/126525) merged on May 12, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/126525) over 1 day, 55 additions and 1 deletion in 3 files</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog)</sub>
...
* **[Michael Goderbauer](https://github.com/goderbauer)** &mdash; Remove dead code
    <sub>[#126266](https://github.com/flutter/flutter/pull/126266) merged on May 9, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/126266) over 1 day, 1 addition and 30 deletions in 9 files</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog)</sub>

* **[Viren Khatri](https://github.com/werainkhatri)** &mdash; fix AppBar's docs for backgroundColor
...
* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool/web: tiniest tweak to wasm help content
    <sub>[#126284](https://github.com/flutter/flutter/pull/126284) merged on May 8, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/126284) over 2 hours, 1 addition and 1 deletion in 1 file</sub>
...
* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Always use `--concurrency=1` for web tests.
    ...
    <sub>Reviewed by: [Jim Graham](https://github.com/flar), [Zachary Anderson](https://github.com/zanderso)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; Add namespace to Android plugin templates
    <sub>[#126354](https://github.com/flutter/flutter/pull/126354) merged on May 12, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/flutter/pull/126354) over 3 days, 83 additions and 0 deletions in 4 files</sub>
...
* **[Pierre-Louis](https://github.com/guidezpl)** &mdash; Provide default constraints for M3 dialogs
    <sub>[#120082](https://github.com/flutter/flutter/pull/120082) merged on May 4, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/120082) over 2 months, 63 additions and 31 deletions in 3 files</sub>
...
* **[Alberto Azinar](https://github.com/albertoazinar)** &mdash; improvement : removed required  kotlin dependency
    <sub>[#125002](https://github.com/flutter/flutter/pull/125002) merged on May 5, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/flutter/pull/125002) over 2 weeks, 1 addition and 3 deletions in 1 file</sub>
...
* **[Yu](https://github.com/373n)** &mdash; Fix typo in README.md
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] Use separate atlases and shaders for color and alpha
    ...
    <sub><details><summary>1 image...</summary>![image](https://user-images.githubusercontent.com/8975114/236598809-f4434764-cd16-4489-9644-4e9a370de7ee.png)</details></sub>
...
* **[Callum Moffat](https://github.com/moffatman)** &mdash; iPhone floating cursor selection
    <sub>[#36643](https://github.com/flutter/engine/pull/36643) merged on May 11, 2023 &mdash; **Large:** [111 comments](https://github.com/flutter/engine/pull/36643) over 7 months, 431 additions and 140 deletions in 3 files</sub>
...
* **[Dan Field](https://github.com/dnfield)** &mdash; [Impeller] [Android] Refactor the Android context/surface implementation to work more like Skia.
    <sub>[#41059](https://github.com/flutter/engine/pull/41059) merged on May 12, 2023 &mdash; **Large:** [12 comments](https://github.com/flutter/engine/pull/41059) over 1 month, 486 additions and 453 deletions in 28 files</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Ignore the Z basis when scaling text
    <sub>[#41995](https://github.com/flutter/engine/pull/41995) merged on May 12, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41995) over 43 minutes, 26 additions and 1 deletion in 4 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[Yegor](https://github.com/yjbanov)** &mdash; [web] generalize focusability in semantics
    <sub>[#41831](https://github.com/flutter/engine/pull/41831) merged on May 10, 2023 &mdash; **Large:** [3 comments](https://github.com/flutter/engine/pull/41831) over 1 day, 515 additions and 17 deletions in 9 files</sub>
...
* **[hellohuanlin](https://github.com/hellohuanlin)** &mdash; [backdrop_filter]Avoid relying on internal class details
    <sub>[#41873](https://github.com/flutter/engine/pull/41873) merged on May 10, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41873) over 23 hours, 6 additions and 6 deletions in 2 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Chris Yang](https://github.com/cyanglaz)</sub>

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] introduces DeviceHolder to avoid accessing a dead Device
    <sub>[#41748](https://github.com/flutter/engine/pull/41748) merged on May 9, 2023 &mdash; **Small:** [11 comments](https://github.com/flutter/engine/pull/41748) over 4 days, 156 additions and 70 deletions in 21 files</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[yaakovschectman](https://github.com/yaakovschectman)** &mdash; Only register top level window message listener upon registering service binding
    <sub>[#41733](https://github.com/flutter/engine/pull/41733) merged on May 10, 2023 &mdash; **Small:** [18 comments](https://github.com/flutter/engine/pull/41733) over 5 days, 82 additions and 1 deletion in 8 files</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog), [Robert Ancell](https://github.com/robert-ancell), [Chris Bracken](https://github.com/cbracken), [Loïc Sharma](https://github.com/loic-sharma)</sub>

* **[Srujan Gaddam](https://github.com/srujzs)** &mdash; Turn @staticInterop tear-off into closure
    <sub>[#41885](https://github.com/flutter/engine/pull/41885) merged on May 11, 2023 &mdash; **Small:** [11 comments](https://github.com/flutter/engine/pull/41885) over 19 hours, 6 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire), [Ian Hickson](https://github.com/Hixie)</sub>

* **[Jim Graham](https://github.com/flar)** &mdash; switch MockTexture off of MockCanvas calls
    <sub>[#41906](https://github.com/flutter/engine/pull/41906) merged on May 11, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41906) over 21 hours, 114 additions and 68 deletions in 5 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>
...
* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] starts running vulkan golden image tests with swiftshader
    <sub>[#41958](https://github.com/flutter/engine/pull/41958) merged on May 12, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/41958) over 23 hours, 40 additions and 4 deletions in 6 files</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>

* **[Dan Field](https://github.com/dnfield)** &mdash; [Impeller] Make index buffer optional
    <sub>[#41962](https://github.com/flutter/engine/pull/41962) merged on May 12, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41962) over 7 hours, 138 additions and 92 deletions in 18 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] started cleaning up pools when devices are deleted
    <sub>[#41857](https://github.com/flutter/engine/pull/41857) merged on May 9, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41857) over 6 hours, 37 additions and 7 deletions in 5 files</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; [Impeller] Remove a debug log from the Vulkan render pass
    <sub>[#41987](https://github.com/flutter/engine/pull/41987) merged on May 12, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41987) over 6 hours, 0 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] Dont synthesize fake index buffer if none was provided to VBB
    <sub>[#41969](https://github.com/flutter/engine/pull/41969) merged on May 12, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41969) over 36 minutes, 22 additions and 16 deletions in 2 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Chris Bracken](https://github.com/cbracken)** &mdash; [macos] Disable background colour tests
    <sub>[#41904](https://github.com/flutter/engine/pull/41904) merged on May 10, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41904) over 2 hours, 4 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Jim Graham](https://github.com/flar)** &mdash; Adjust DL filter bounds tests to not rely on exact Skia results
    <sub>[#41792](https://github.com/flutter/engine/pull/41792) merged on May 8, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41792) over 2 days, 21 additions and 18 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] Increase minimum size of alpha glyph atlas.
    <sub>[#41880](https://github.com/flutter/engine/pull/41880) merged on May 10, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41880) over 58 minutes, 8 additions and 6 deletions in 2 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] delete special handling of RRect.
    <sub>[#41872](https://github.com/flutter/engine/pull/41872) merged on May 10, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41872) over 19 hours, 64 additions and 220 deletions in 5 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Re-enable history tests on Safari
...
* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Cleaner output on LUCI
    <sub>[#41989](https://github.com/flutter/engine/pull/41989) merged on May 12, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41989) over 2 hours, 9 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [Harry Terkelsen](https://github.com/hterkelsen), [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>

* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Fix crash on old versions of Chrome (Intl.Segmenter missing)
    <sub>[#41986](https://github.com/flutter/engine/pull/41986) merged on May 12, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41986) over 2 hours, 48 additions and 3 deletions in 3 files</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Move clang tidy v2 build to prod.
    <sub>[#41985](https://github.com/flutter/engine/pull/41985) merged on May 12, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41985) over 1 hour, 15 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Bruno Leroux](https://github.com/bleroux)** &mdash; [Linux - TextInput] Do not add new line for send action
    <sub>[#41895](https://github.com/flutter/engine/pull/41895) merged on May 11, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/engine/pull/41895) over 1 day, 69 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [J-P Nurmi](https://github.com/jpnurmi), [Chris Bracken](https://github.com/cbracken)</sub>
...
* **[drwez](https://github.com/drwez)** &mdash; [tests] Remove unused fuchsia.sys protocol reference
    <sub>[#41826](https://github.com/flutter/engine/pull/41826) merged on May 9, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41826) over 5 hours, 0 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [David Worsham](https://github.com/arbreng)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Add linux license engine v2 build.
...
* **[godofredoc](https://github.com/godofredoc)** &mdash; Linux fuchsia engine v2 config.
    <sub>[#41759](https://github.com/flutter/engine/pull/41759) merged on May 8, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41759) over 3 days, 213 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Bruno Leroux](https://github.com/bleroux)** &mdash; [Web+Linux] Fix pressing Meta keys throws
    <sub>[#41694](https://github.com/flutter/engine/pull/41694) merged on May 12, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41694) over 1 week, 34 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Tong Mu](https://github.com/dkwingsmt)</sub>

* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Get rid of "outrageous" default text styles for HTML renderer.
    <sub>[#41822](https://github.com/flutter/engine/pull/41822) merged on May 8, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/41822) over 3 hours, 5 additions and 34 deletions in 6 files</sub>
    <sub>Reviewed by: [Yegor](https://github.com/yjbanov), [Mouad Debbar](https://github.com/mdebbar)</sub>

* **[Michael Ludwig](https://github.com/lhkbob)** &mdash; Remove GN staging flag for save layer bounds
    <sub>[#41940](https://github.com/flutter/engine/pull/41940) merged on May 11, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41940) over 6 hours, 0 additions and 2 deletions in 1 file</sub>
...
* **[Michael Ludwig](https://github.com/lhkbob)** &mdash; Remove staging flag
    <sub>[#41843](https://github.com/flutter/engine/pull/41843) merged on May 9, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41843) over 18 hours, 0 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons), [Jim Graham](https://github.com/flar)</sub>

* **[Greg Spencer](https://github.com/gspencergoog)** &mdash; [Android] Lifecycle defaults to focused instead of unfocused
    <sub>[#41875](https://github.com/flutter/engine/pull/41875) merged on May 11, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41875) over 1 day, 9 additions and 9 deletions in 2 files</sub>
    <sub>Reviewed by: [Loïc Sharma](https://github.com/loic-sharma)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Increase timeout of orchestrator.
    <sub>[#41839](https://github.com/flutter/engine/pull/41839) merged on May 9, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41839) over 2 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>

* **[lauren n. liberda](https://github.com/selfisekai)** &mdash; allow supplying custom gn args in gn wrapper
    <sub>[#41794](https://github.com/flutter/engine/pull/41794) merged on May 11, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41794) over 5 days, 9 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Clobber caches in licenses test.
    <sub>[#41942](https://github.com/flutter/engine/pull/41942) merged on May 11, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41942) over 2 hours, 1 addition and 0 deletions in 1 file</sub>
...
* **[Kevin Lubick](https://github.com/kjlubick)** &mdash; Use moved SkImage procs
    <sub>[#41947](https://github.com/flutter/engine/pull/41947) merged on May 11, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41947) over 2 hours, 2 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[Victoria Ashworth](https://github.com/vashworth)** &mdash; Update README.md
    <sub>[#41953](https://github.com/flutter/engine/pull/41953) merged on May 11, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41953) over 56 minutes, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Chris Yang](https://github.com/cyanglaz)</sub>

* **[Samuel](https://github.com/Mayb3Nots)** &mdash; fix: platform_dispatcher documentation typo
    <sub>[#41739](https://github.com/flutter/engine/pull/41739) merged on May 11, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41739) over 1 week, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Jason Simmons](https://github.com/jason-simmons)</sub>
...
* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Reland "Skwasm Font Loading
    <sub>[#41756](https://github.com/flutter/engine/pull/41756) merged on May 8, 2023 &mdash; **Extra large:** [1 comment](https://github.com/flutter/engine/pull/41756) over 3 days, 1431 additions and 913 deletions in 117 files</sub>
    <sub>Reviewed by: [Harry Terkelsen](https://github.com/hterkelsen)</sub>

* **[skia-flutter-autoroll](https://github.com/skia-flutter-autoroll)** &mdash; Roll Clang from 5344d8e10bb7 to 6d667d4b261e
    <sub>[#41949](https://github.com/flutter/engine/pull/41949) merged on May 11, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41949) over 1 hour, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Revert "Move linux fuchsia engine v2 build to prod."
    <sub>[#41902](https://github.com/flutter/engine/pull/41902) merged on May 10, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41902) over 6 minutes, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Casey Hillers](https://github.com/CaseyHillers)** &mdash; Revert "Remove GN staging flag for save layer bounds"
    <sub>[#42026](https://github.com/flutter/engine/pull/42026) merged on May 14, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/42026) over 51 minutes, 2 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Reland "Move linux_license to engine v2.""
    <sub>[#41983](https://github.com/flutter/engine/pull/41983) merged on May 12, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41983) over 1 hour, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Alexander Aprelev](https://github.com/aam)</sub>
...
* **[godofredoc](https://github.com/godofredoc)** &mdash; reland "Migrate mac_host_engine to engine v2 builds."
    <sub>[#41531](https://github.com/flutter/engine/pull/41531) merged on April 27, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41531) over 4 hours, 27 additions and 13 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[Tarrin Neal](https://github.com/tarrinneal)** &mdash; [video_player] foundation - reduce seek accuracy to fix seek to end bug
    <sub>[#3784](https://github.com/flutter/packages/pull/3784) merged on May 11, 2023 &mdash; **Small:** [40 comments](https://github.com/flutter/packages/pull/3784) over 2 weeks, 205 additions and 18 deletions in 6 files</sub>
    <sub>Reviewed by: [hellohuanlin](https://github.com/hellohuanlin), [stuartmorgan](https://github.com/stuartmorgan)</sub>

* **[Ahmed Fwela](https://github.com/ahmednfwela)** &mdash; [go_router] change `fix_data.yaml` uris to be absolute to fix lints
    <sub>[#3877](https://github.com/flutter/packages/pull/3877) merged on May 11, 2023 &mdash; **Small:** [78 comments](https://github.com/flutter/packages/pull/3877) over 1 week, 102 additions and 19 deletions in 5 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [chunhtai](https://github.com/chunhtai)</sub>

* **[André Sousa](https://github.com/beroso)** &mdash; [image_picker_android] Improved Bitmap resize on Android
    <sub>[#3423](https://github.com/flutter/packages/pull/3423) merged on May 10, 2023 &mdash; **Small:** [24 comments](https://github.com/flutter/packages/pull/3423) over 2 months, 113 additions and 13 deletions in 5 files</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [image_picker] Fix Android lints
    <sub>[#3887](https://github.com/flutter/packages/pull/3887) merged on May 12, 2023 &mdash; **Large:** [4 comments](https://github.com/flutter/packages/pull/3887) over 1 week, 79 additions and 486 deletions in 9 files</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [ci] Ensure scripts fail if a command fails
    <sub>[#3963](https://github.com/flutter/packages/pull/3963) merged on May 12, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3963) over 10 hours, 13 additions and 0 deletions in 11 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>

* **[Camille Simon](https://github.com/camsim99)** &mdash; [camerax] Publish plugin
    <sub>[#3896](https://github.com/flutter/packages/pull/3896) merged on May 9, 2023 &mdash; **Small:** [12 comments](https://github.com/flutter/packages/pull/3896) over 6 days, 21 additions and 28 deletions in 3 files</sub>
...
* **[Bernardo Ferrari](https://github.com/bernaferrari)** &mdash; Remove `describeEnum`.
    <sub>[#3753](https://github.com/flutter/packages/pull/3753) merged on May 9, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/packages/pull/3753) over 3 weeks, 8 additions and 10 deletions in 6 files</sub>
    <sub>Reviewed by: [Chris Yang](https://github.com/cyanglaz)</sub>

* **[Justin McCandless](https://github.com/justinmc)** &mdash; Fix nullability in docs
    <sub>[#3876](https://github.com/flutter/packages/pull/3876) merged on May 9, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/packages/pull/3876) over 1 week, 5 additions and 4 deletions in 3 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [ci] Add LUCI repo tool tests
    <sub>[#3964](https://github.com/flutter/packages/pull/3964) merged on May 12, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/packages/pull/3964) over 1 day, 20 additions and 9 deletions in 4 files</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>
...
* **[Reid Baker](https://github.com/reidbaker)** &mdash; Update build.gradle with a comment explaining version
    <sub>[#3972](https://github.com/flutter/packages/pull/3972) merged on May 12, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/packages/pull/3972) over 4 hours, 3 additions and 0 deletions in 1 file</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [image_picker] Fix use_build_context_synchronously violations
    ...
    <sub>Reviewed by: [Sam Rawlins](https://github.com/srawlins), [Tarrin Neal](https://github.com/tarrinneal)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [tool] Ensure that publish credential path is available
    <sub>[#3970](https://github.com/flutter/packages/pull/3970) merged on May 11, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/packages/pull/3970) over 1 hour, 20 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [tool] Use new pub cache location for publish
    <sub>[#3962](https://github.com/flutter/packages/pull/3962) merged on May 11, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/3962) over 9 hours, 85 additions and 35 deletions in 2 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [various] Remove iOS 9 references
    ...
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman), [Kate Lovett](https://github.com/Piinks), [Tarrin Neal](https://github.com/tarrinneal)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [tools] Check version ranges when pathifying deps
    <sub>[#3943](https://github.com/flutter/packages/pull/3943) merged on May 8, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/packages/pull/3943) over 5 hours, 132 additions and 25 deletions in 2 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[engine-flutter-autoroll](https://github.com/engine-flutter-autoroll)** &mdash; Roll Flutter (stable) from f72efea43c30 to 84a1e904f44f (1920 revisions)
    <sub>[#3961](https://github.com/flutter/packages/pull/3961) merged on May 10, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/3961) over 2 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>
