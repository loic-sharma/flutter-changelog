...
* **[Lau Ching Jun](https://github.com/chingjun)** &mdash; Revert "Dynamic view sizing"<br />
    <sub>[#140165](https://github.com/flutter/flutter/pull/140165) merged on December 14, 2023 &mdash; **Medium:** [2 comments](https://github.com/flutter/flutter/pull/140165) over 32 minutes, 43 additions and 291 deletions in 16 files</sub><br />
...
* **[xubaolin](https://github.com/xu-baolin)** &mdash; Introduce multi-touch drag strategies for `DragGestureRecognizer`<br />
    <sub>[#136708](https://github.com/flutter/flutter/pull/136708) merged on November 30, 2023 &mdash; **Small:** [28 comments](https://github.com/flutter/flutter/pull/136708) over 1 month, 258 additions and 6 deletions in 6 files</sub><br />
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub><br />
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix chips `onDeleted` callback don't show the delete button when disabled<br />
    <sub>[#137685](https://github.com/flutter/flutter/pull/137685) merged on November 29, 2023 &mdash; **Small:** [17 comments](https://github.com/flutter/flutter/pull/137685) over 4 weeks, 83 additions and 9 deletions in 4 files</sub><br />
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller), [Kate Lovett](https://github.com/Piinks)</sub><br />
...
* **[yakagami](https://github.com/yakagami)** &mdash; add sourceTimeStamp to ScaleUpdateDetails<br />
    <sub>[#135936](https://github.com/flutter/flutter/pull/135936) merged on November 29, 2023 &mdash; **Medium:** [30 comments](https://github.com/flutter/flutter/pull/135936) over 1 month, 315 additions and 1 deletion in 2 files</sub><br />
...
* **[Bruno Leroux](https://github.com/bleroux)** &mdash; [l10n] Update Material shareButtonLabel<br />
    <sub>[#138899](https://github.com/flutter/flutter/pull/138899) merged on December 1, 2023 &mdash; **Small:** [12 comments](https://github.com/flutter/flutter/pull/138899) over 1 week, 37 additions and 7 deletions in 4 files</sub><br />
...
* **[LongCatIsLooong](https://github.com/LongCatIsLooong)** &mdash; Ensure Icon vertically centers its icon glyph.<br />
    <sub>[#138937](https://github.com/flutter/flutter/pull/138937) merged on November 28, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/138937) over 5 days, 38 additions and 17 deletions in 2 files</sub><br />
...
* **[Christopher Fujino](https://github.com/christopherfujino)** &mdash; Refactor prepare_package.dart<br />
    <sub>[#139277](https://github.com/flutter/flutter/pull/139277) merged on November 30, 2023 &mdash; **Extra large:** [1 comment](https://github.com/flutter/flutter/pull/139277) over 18 hours, 986 additions and 906 deletions in 6 files</sub><br />
    <sub>Reviewed by: [Casey Hillers](https://github.com/CaseyHillers)</sub><br />
...
* **[Michael Goderbauer](https://github.com/goderbauer)** &mdash; Dynamic view sizing<br />
    <sub>[#138648](https://github.com/flutter/flutter/pull/138648) merged on November 29, 2023 &mdash; **Medium:** [12 comments](https://github.com/flutter/flutter/pull/138648) over 1 week, 291 additions and 43 deletions in 16 files</sub><br />
...
* **[Renzo Olivares](https://github.com/Renzo-Olivares)** &mdash; Add `undoStackModifier` to `UndoHistory`<br />
    <sub>[#138674](https://github.com/flutter/flutter/pull/138674) merged on November 30, 2023 &mdash; **Small:** [12 comments](https://github.com/flutter/flutter/pull/138674) over 1 week, 44 additions and 20 deletions in 3 files</sub><br />
    <sub>Reviewed by: [LongCatIsLooong](https://github.com/LongCatIsLooong)</sub><br />

* **[Kristijan Žic](https://github.com/KristijanZic)** &mdash; Added vscode-insiders path installed via snap<br />
    <sub>[#137117](https://github.com/flutter/flutter/pull/137117) merged on December 1, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/137117) over 1 month, 7 additions and 1 deletion in 2 files</sub><br />
...
* **[Kate Lovett](https://github.com/Piinks)** &mdash; Update VelocityTracker (4)<br />
    <sub>[#139166](https://github.com/flutter/flutter/pull/139166) merged on November 29, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/139166) over 19 hours, 178 additions and 65 deletions in 9 files</sub><br />
    <sub>Reviewed by: [chunhtai](https://github.com/chunhtai)</sub><br />
...
* **[Ian Hickson](https://github.com/Hixie)** &mdash; Retry on transient Skia failure.<br />
    <sub>[#139182](https://github.com/flutter/flutter/pull/139182) merged on December 1, 2023 &mdash; **Small:** [13 comments](https://github.com/flutter/flutter/pull/139182) over 2 days, 204 additions and 34 deletions in 3 files</sub><br />
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub><br />
...
* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Move Impeller tests on Pixel 7 Pro from staging to prod<br />
    <sub>[#139280](https://github.com/flutter/flutter/pull/139280) merged on November 30, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/139280) over 11 hours, 12 additions and 41 deletions in 1 file</sub><br />
...
* **[Kallen Tu](https://github.com/kallentu)** &mdash; Bump DartDoc to 8.0.0<br />
    ...
    <sub>Reviewed by: [Sam Rawlins](https://github.com/srawlins), [Michael Goderbauer](https://github.com/goderbauer)</sub><br />
...
* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; Typo fix in dartdoc in tool test<br />
    <sub>[#139386](https://github.com/flutter/flutter/pull/139386) merged on December 1, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/139386) over 8 minutes, 1 addition and 1 deletion in 1 file</sub><br />
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub><br />
...
* **[Victoria Ashworth](https://github.com/vashworth)** &mdash; Renable macOS 13 tests<br />
    <sub>[#139083](https://github.com/flutter/flutter/pull/139083) merged on November 28, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/139083) over 20 hours, 6 additions and 6 deletions in 1 file</sub><br />
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub><br />
...
* **[Tirth](https://github.com/piedcipher)** &mdash; Write Tests for API Examples of `cupertino_text_field.0`, `data_table.0`, `icon_button.2` & `ink_well.0`<br />
    <sub>[#139258](https://github.com/flutter/flutter/pull/139258) merged on November 30, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/flutter/pull/139258) over 23 hours, 92 additions and 4 deletions in 5 files</sub><br />
...
* **[Jim Kalafut](https://github.com/kalafut)** &mdash; Fix header formatting typo in PopupMenuButton docs<br />
    <sub>[#139084](https://github.com/flutter/flutter/pull/139084) merged on November 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/139084) over 22 hours, 1 addition and 1 deletion in 1 file</sub><br />
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer), [Kate Lovett](https://github.com/Piinks)</sub><br />
...
* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "Reland Add platform view wide gamut test"<br />
    <sub>[#139189](https://github.com/flutter/flutter/pull/139189) merged on November 29, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/139189) over 1 minute, 0 additions and 117 deletions in 3 files</sub><br />
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub><br />
...
* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] Turned on new blur.<br />
    <sub>[#48472](https://github.com/flutter/engine/pull/48472) merged on December 14, 2023 &mdash; **Small:** [17 comments](https://github.com/flutter/engine/pull/48472) over 2 weeks, 7 additions and 32 deletions in 2 files</sub><br />
...
* **[Matej Knopp](https://github.com/knopp)** &mdash; Reduce number of surfaces required when presenting platform views<br />
    <sub>[#43301](https://github.com/flutter/engine/pull/43301) merged on November 27, 2023 &mdash; **Large:** [19 comments](https://github.com/flutter/engine/pull/43301) over 5 months, 381 additions and 226 deletions in 12 files</sub><br />
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub><br />

* **[Camille Simon](https://github.com/camsim99)** &mdash; [Android] Check for text to paste before trying to retrieve data from URI<br />
    <sub>[#48166](https://github.com/flutter/engine/pull/48166) merged on December 1, 2023 &mdash; **Medium:** [11 comments](https://github.com/flutter/engine/pull/48166) over 1 week, 214 additions and 108 deletions in 2 files</sub><br />
...
* **[Harry Terkelsen](https://github.com/harryterkelsen)** &mdash; [canvaskit] Enable multiview rendering<br />
    <sub>[#48301](https://github.com/flutter/engine/pull/48301) merged on November 27, 2023 &mdash; **Large:** [26 comments](https://github.com/flutter/engine/pull/48301) over 5 days, 335 additions and 271 deletions in 21 files</sub><br />
    <sub>Reviewed by: [Yegor](https://github.com/yjbanov), [David Iglesias](https://github.com/ditman)</sub><br />

* **[Michael Goderbauer](https://github.com/goderbauer)** &mdash; Dynamic view sizing [dart:ui]<br />
    <sub>[#48090](https://github.com/flutter/engine/pull/48090) merged on November 27, 2023 &mdash; **Medium:** [34 comments](https://github.com/flutter/engine/pull/48090) over 1 week, 336 additions and 19 deletions in 11 files</sub><br />
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman), [Tong Mu](https://github.com/dkwingsmt), [Greg Spencer](https://github.com/gspencergoog)</sub><br />

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] Started expanding the blur clip region<br />
    <sub>[#48535](https://github.com/flutter/engine/pull/48535) merged on November 30, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/48535) over 2 hours, 34 additions and 7 deletions in 1 file</sub><br />
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub><br />
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] Recycle descriptor sets.<br />
    <sub>[#48343](https://github.com/flutter/engine/pull/48343) merged on November 28, 2023 &mdash; **Medium:** [2 comments](https://github.com/flutter/engine/pull/48343) over 4 days, 412 additions and 52 deletions in 11 files</sub><br />
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey)</sub><br />
...
* **[Yegor](https://github.com/yjbanov)** &mdash; [web] Implement multi-view for semantics<br />
    <sub>[#48251](https://github.com/flutter/engine/pull/48251) merged on December 1, 2023 &mdash; **Large:** [19 comments](https://github.com/flutter/engine/pull/48251) over 1 week, 913 additions and 575 deletions in 25 files</sub><br />
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman), [Mouad Debbar](https://github.com/mdebbar)</sub><br />

* **[Robert Ancell](https://github.com/robert-ancell)** &mdash; Fix the application not disposing by breaking circular references on quit<br />
    <sub>[#47684](https://github.com/flutter/engine/pull/47684) merged on November 29, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/engine/pull/47684) over 3 weeks, 111 additions and 3 deletions in 2 files</sub><br />
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub><br />

* **[Jim Graham](https://github.com/flar)** &mdash; [Impeller] Fix size of squares in DrawPoints(PointMode).<br />
    <sub>[#48547](https://github.com/flutter/engine/pull/48547) merged on December 1, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/48547) over 19 hours, 1 addition and 1 deletion in 1 file</sub><br />
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub><br />

* **[Harry Terkelsen](https://github.com/harryterkelsen)** &mdash; [canvaskit] Disable createImageBitmap support on Chrome 110 or older on Windows.<br />
    <sub>[#48475](https://github.com/flutter/engine/pull/48475) merged on November 29, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/48475) over 19 hours, 56 additions and 6 deletions in 3 files</sub><br />
    <sub>Reviewed by: [Yegor](https://github.com/yjbanov)</sub><br />

* **[Harry Terkelsen](https://github.com/harryterkelsen)** &mdash; [canvaskit] Revert to `drawImage` rendering on Chrome 110 or earlier<br />
    <sub>[#48515](https://github.com/flutter/engine/pull/48515) merged on November 30, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/48515) over 20 hours, 16 additions and 18 deletions in 3 files</sub><br />
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman)</sub><br />
...
* **[Harry Terkelsen](https://github.com/harryterkelsen)** &mdash; [canvaskit] Add ImageFilter.compose<br />
    <sub>[#48546](https://github.com/flutter/engine/pull/48546) merged on December 1, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/48546) over 2 hours, 106 additions and 7 deletions in 4 files</sub><br />
    <sub>Reviewed by: [Yegor](https://github.com/yjbanov)</sub><br />

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] fix order of operations in SkSL generated texture lookup.<br />
    <sub>[#48488](https://github.com/flutter/engine/pull/48488) merged on November 29, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/48488) over 12 hours, 75 additions and 9 deletions in 6 files</sub><br />
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub><br />
...
* **[Dan Field](https://github.com/dnfield)** &mdash; Avoid reloading the kernel snapshot when spawning an isolate in the same group<br />
    <sub>[#48478](https://github.com/flutter/engine/pull/48478) merged on December 1, 2023 &mdash; **Small:** [31 comments](https://github.com/flutter/engine/pull/48478) over 2 days, 181 additions and 45 deletions in 5 files</sub><br />
    <sub>Reviewed by: [gaaclarke](https://github.com/gaaclarke)</sub><br />

* **[Loïc Sharma](https://github.com/loic-sharma)** &mdash; [Windows] Begin decoupling text input plugin from the view<br />
    <sub>[#47833](https://github.com/flutter/engine/pull/47833) merged on November 30, 2023 &mdash; **Medium:** [17 comments](https://github.com/flutter/engine/pull/47833) over 3 weeks, 248 additions and 121 deletions in 10 files</sub><br />
...
* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] No implicit view in multi-view mode<br />
    <sub>[#48505](https://github.com/flutter/engine/pull/48505) merged on November 29, 2023 &mdash; **Small:** [9 comments](https://github.com/flutter/engine/pull/48505) over 3 hours, 79 additions and 50 deletions in 13 files</sub><br />
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman), [Harry Terkelsen](https://github.com/harryterkelsen)</sub><br />

* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Try rolling a new version of googletest (2021->2023).<br />
    <sub>[#48285](https://github.com/flutter/engine/pull/48285) merged on December 1, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/48285) over 1 week, 27 additions and 70 deletions in 3 files</sub><br />
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub><br />

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] fix descriptor pool recycler test flake.<br />
    <sub>[#48479](https://github.com/flutter/engine/pull/48479) merged on November 29, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/48479) over 47 minutes, 78 additions and 9 deletions in 1 file</sub><br />
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey)</sub><br />

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] Add benchmarks that measure the time it takes to record canvas operations.<br />
    <sub>[#48374](https://github.com/flutter/engine/pull/48374) merged on November 28, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/48374) over 2 days, 84 additions and 0 deletions in 9 files</sub><br />
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey), [gaaclarke](https://github.com/gaaclarke)</sub><br />

* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Update `HeaderFilterRegex` once and for all.<br />
    <sub>[#48145](https://github.com/flutter/engine/pull/48145) merged on November 27, 2023 &mdash; **Medium:** [6 comments](https://github.com/flutter/engine/pull/48145) over 1 week, 250 additions and 141 deletions in 33 files</sub><br />
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso), [Jonah Williams](https://github.com/jonahwilliams)</sub><br />

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Remove use of variable length arrays<br />
    <sub>[#48232](https://github.com/flutter/engine/pull/48232) merged on November 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/48232) over 1 week, 24 additions and 24 deletions in 6 files</sub><br />
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub><br />
...
* **[Jim Graham](https://github.com/flar)** &mdash; SurfaceFrame root DisplayLists will no longer prepare an RTree<br />
...
* **[Dan Field](https://github.com/dnfield)** &mdash; Fix CanonicalizeURL for file schema<br />
    <sub>[#48466](https://github.com/flutter/engine/pull/48466) merged on November 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/48466) over 4 hours, 52 additions and 27 deletions in 8 files</sub><br />
...
* **[Victoria Ashworth](https://github.com/vashworth)** &mdash; Renable macOS 13 tests<br />
    <sub>[#48418](https://github.com/flutter/engine/pull/48418) merged on December 1, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/48418) over 4 days, 42 additions and 42 deletions in 8 files</sub><br />
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub><br />

* **[Jesse Seales](https://github.com/sealesj)** &mdash; Use Chromium mirror for archive dependency<br />
    <sub>[#48509](https://github.com/flutter/engine/pull/48509) merged on November 30, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/48509) over 20 hours, 1 addition and 1 deletion in 1 file</sub><br />
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub><br />
...
* **[Bruno Leroux](https://github.com/bleroux)** &mdash; [Android] Add support for the PlatformChannel  "Share.invoke" command<br />
    <sub>[#48265](https://github.com/flutter/engine/pull/48265) merged on November 30, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/48265) over 1 week, 89 additions and 0 deletions in 4 files</sub><br />
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker)</sub><br />
...
* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "binary_messenger missing cstdint"<br />
    <sub>[#48483](https://github.com/flutter/engine/pull/48483) merged on November 29, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/48483) over 55 seconds, 0 additions and 1 deletion in 1 file</sub><br />
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub><br />

* **[Joel Winarske](https://github.com/jwinarske)** &mdash; binary_messenger missing cstdint<br />
    <sub>[#48481](https://github.com/flutter/engine/pull/48481) merged on November 29, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/engine/pull/48481) over 1 hour, 1 addition and 0 deletions in 1 file</sub><br />
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub><br />

* **[Kevin Lubick](https://github.com/kjlubick)** &mdash; Replace all calls to SkTypeface::Make with SkFontMgr ones<br />
    <sub>[#48319](https://github.com/flutter/engine/pull/48319) merged on November 28, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/48319) over 5 days, 57 additions and 15 deletions in 15 files</sub><br />
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub><br />

* **[skia-flutter-autoroll](https://github.com/skia-flutter-autoroll)** &mdash; Manual roll Dart SDK to 3.3.0-174.2.beta (4 revisions)<br />
    <sub>[#48538](https://github.com/flutter/engine/pull/48538) merged on November 30, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/48538) over 4 hours, 7 additions and 7 deletions in 2 files</sub><br />
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [google_maps_flutter] Add support for version 8 of the iOS SDK<br />
    <sub>[#5528](https://github.com/flutter/packages/pull/5528) merged on November 30, 2023 &mdash; **Extra large:** [3 comments](https://github.com/flutter/packages/pull/5528) over 2 hours, 1676 additions and 213 deletions in 56 files</sub><br />
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman)</sub><br />
...
* **[LouiseHsu](https://github.com/LouiseHsu)** &mdash; [pointer_interceptor] Add platform interface<br />
    <sub>[#5499](https://github.com/flutter/packages/pull/5499) merged on November 30, 2023 &mdash; **Small:** [23 comments](https://github.com/flutter/packages/pull/5499) over 1 day, 199 additions and 0 deletions in 10 files</sub><br />
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [hellohuanlin](https://github.com/hellohuanlin), [David Iglesias](https://github.com/ditman)</sub><br />
...
* **[Nitin-Poojary](https://github.com/Nitin-Poojary)** &mdash; [flutter image] Changed image link to use image within package<br />
    <sub>[#5326](https://github.com/flutter/packages/pull/5326) merged on November 28, 2023 &mdash; **Small:** [16 comments](https://github.com/flutter/packages/pull/5326) over 3 weeks, 7 additions and 6 deletions in 3 files</sub><br />
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Tarrin Neal](https://github.com/tarrinneal)</sub><br />
...
* **[Kevin Moore](https://github.com/kevmoo)** &mdash; [cross_file] Migrate to pkg:web, bump min SDK to Dart 3.2<br />
    <sub>[#5520](https://github.com/flutter/packages/pull/5520) merged on November 30, 2023 &mdash; **Small:** [13 comments](https://github.com/flutter/packages/pull/5520) over 1 day, 66 additions and 44 deletions in 8 files</sub><br />
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [pointer_interceptor] Re-land: Add platform interface<br />
    <sub>[#5525](https://github.com/flutter/packages/pull/5525) merged on November 30, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/5525) over 4 hours, 199 additions and 0 deletions in 10 files</sub><br />
    <sub>Reviewed by: [LouiseHsu](https://github.com/LouiseHsu)</sub><br />

* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "[pointer_interceptor] Add platform interface"<br />
    <sub>[#5524](https://github.com/flutter/packages/pull/5524) merged on November 30, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/packages/pull/5524) over 1 minute, 0 additions and 199 deletions in 10 files</sub><br />
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub><br />

* **[Ian Hickson](https://github.com/Hixie)** &mdash; [rfw, flutter_markdown] Prepare for removing dart:ui imports.<br />
    <sub>[#5471](https://github.com/flutter/packages/pull/5471) merged on November 28, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/5471) over 4 days, 5 additions and 0 deletions in 5 files</sub><br />
    <sub>Reviewed by: [Brett Morgan](https://github.com/domesticmouse)</sub><br />
