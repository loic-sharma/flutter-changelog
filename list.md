...
* **[Yegor](https://github.com/yjbanov)** &mdash; [web] unskip canvaskit tests that pass now
    <sub>[#140480](https://github.com/flutter/flutter/pull/140480) merged on December 22, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/140480) over 1 day, 0 additions and 16 deletions in 1 file</sub>
...
* **[Reid Baker](https://github.com/reidbaker)** &mdash; Use double quotes over single quotes in gradle build files
    <sub>[#140512](https://github.com/flutter/flutter/pull/140512) merged on December 22, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/140512) over 23 hours, 69 additions and 69 deletions in 1 file</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino), [Gray Mackall](https://github.com/gmackall), [Bartek Pacia](https://github.com/bartekpacia)</sub>
...
* **[Jim Graham](https://github.com/flar)** &mdash; [Impeller] Remove use of private Rect fields from PathBuilder
    <sub>[#49334](https://github.com/flutter/engine/pull/49334) merged on December 21, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/49334) over 3 hours, 136 additions and 52 deletions in 3 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>
...
* **[Dan Field](https://github.com/dnfield)** &mdash; Fix GetImpellerContext for ShellTestPlatformViewGL
    <sub>[#49337](https://github.com/flutter/engine/pull/49337) merged on December 22, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/49337) over 4 hours, 50 additions and 5 deletions in 4 files</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>
...
* **[keyonghan](https://github.com/keyonghan)** &mdash; Disable `presubmit: false` targets for recipes CQ
    <sub>[#5735](https://github.com/flutter/packages/pull/5735) merged on December 21, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/5735) over 41 minutes, 0 additions and 6 deletions in 1 file</sub>
    <sub>Reviewed by: [godofredoc](https://github.com/godofredoc)</sub>
