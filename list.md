...
* **[getBoolean](https://github.com/getBoolean)** &mdash; [go_router] Add `topRoute` to `GoRouterState`
    <sub>[#5736](https://github.com/flutter/packages/pull/5736) merged on January 28, 2024 &mdash; **Medium:** [20 comments](https://github.com/flutter/packages/pull/5736) over 1 month, 431 additions and 1 deletion in 8 files</sub>
