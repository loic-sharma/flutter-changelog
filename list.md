...
* **[Elias Yishak](https://github.com/eliasyishak)** &mdash; Opt out users from GA3 if opted out of GA4
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix InputDecorator suffix and prefix IconButtons ignore `IconButtonTheme`
    <sub>[#145473](https://github.com/flutter/flutter/pull/145473) merged on April 4, 2024 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/145473) over 2 weeks, 169 additions and 14 deletions in 2 files</sub>
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix `MenuItemButton` overflow
...
* **[Ian Hickson](https://github.com/Hixie)** &mdash; Magnifier cleanup
    <sub>[#143558](https://github.com/flutter/flutter/pull/143558) merged on April 3, 2024 &mdash; **Large:** [49 comments](https://github.com/flutter/flutter/pull/143558) over 1 month, 395 additions and 195 deletions in 12 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc), [Bruno Leroux](https://github.com/bleroux)</sub>

* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Add `DropdownMenu` cursor behavior sample
    <sub>[#146133](https://github.com/flutter/flutter/pull/146133) merged on April 3, 2024 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/146133) over 1 day, 226 additions and 0 deletions in 3 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>
...
* **[Bruno Leroux](https://github.com/bleroux)** &mdash; Fix cursor is not centered when cursorHeight is set (non-Apple platforms).
    <sub>[#145829](https://github.com/flutter/flutter/pull/145829) merged on April 5, 2024 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/145829) over 1 week, 98 additions and 6 deletions in 2 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc)</sub>
...
* **[Igor Hnízdo](https://github.com/Michal-MK)** &mdash; `ExpansionTile` Unable to remove right padding from title
    <sub>[#145271](https://github.com/flutter/flutter/pull/145271) merged on April 4, 2024 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/145271) over 2 weeks, 41 additions and 1 deletion in 2 files</sub>
...
* **[Gray Mackall](https://github.com/gmackall)** &mdash; Bump to AGP 8.1/Gradle 8.3 (almost) everywhere
    <sub>[#146181](https://github.com/flutter/flutter/pull/146181) merged on April 4, 2024 &mdash; **Extra large:** [9 comments](https://github.com/flutter/flutter/pull/146181) over 1 day, 2388 additions and 2013 deletions in 105 files</sub>
...
* **[Gray Mackall](https://github.com/gmackall)** &mdash; Set up Kotlin linting step in ci with ktlint
    <sub>[#143478](https://github.com/flutter/flutter/pull/143478) merged on April 3, 2024 &mdash; **Small:** [18 comments](https://github.com/flutter/flutter/pull/143478) over 1 month, 69 additions and 9 deletions in 8 files</sub>
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker)</sub>
...
* **[Kallen Tu](https://github.com/kallentu)** &mdash; Add `missing_code_block_language_in_doc_comment` lint.
...
* **[Kostia Sokolovskyi](https://github.com/ksokolovskyi)** &mdash; Add tests for theme_extension.1.dart API example.
    <sub>[#145819](https://github.com/flutter/flutter/pull/145819) merged on April 3, 2024 &mdash; **Small:** [13 comments](https://github.com/flutter/flutter/pull/145819) over 1 week, 112 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [Renzo Olivares](https://github.com/Renzo-Olivares), [Greg Spencer](https://github.com/gspencergoog)</sub>

* **[Kostia Sokolovskyi](https://github.com/ksokolovskyi)** &mdash; Add tests for material_state_mouse_cursor.0.dart API example.
    <sub>[#145987](https://github.com/flutter/flutter/pull/145987) merged on April 3, 2024 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/145987) over 4 days, 92 additions and 7 deletions in 3 files</sub>
    <sub>Reviewed by: [Renzo Olivares](https://github.com/Renzo-Olivares), [Greg Spencer](https://github.com/gspencergoog)</sub>

* **[Jenn Magder](https://github.com/jmagman)** &mdash; Remove dead `compareIosVersions` function
    <sub>[#146298](https://github.com/flutter/flutter/pull/146298) merged on April 4, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/146298) over 2 hours, 0 additions and 38 deletions in 2 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Gray Mackall](https://github.com/gmackall)** &mdash; Give `generate_gradle_lockfiles.dart` functionality to exclude certain subdirectories
...
* **[Jesse](https://github.com/sealesj)** &mdash; Refactor fuchsia_precache
    <sub>[#145978](https://github.com/flutter/flutter/pull/145978) merged on April 3, 2024 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/145978) over 5 days, 33 additions and 26 deletions in 2 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer)</sub>
...
* **[Jesse](https://github.com/sealesj)** &mdash; Refactor realm_checker
    <sub>[#145905](https://github.com/flutter/flutter/pull/145905) merged on April 1, 2024 &mdash; **Small:** [7 comments](https://github.com/flutter/flutter/pull/145905) over 4 days, 20 additions and 9 deletions in 2 files</sub>
...
* **[LongCatIsLooong](https://github.com/LongCatIsLooong)** &mdash; Fix chip baseline implementation
...
* **[flutter-pub-roller-bot](https://github.com/flutter-pub-roller-bot)** &mdash; Roll pub packages
    <sub>[#146348](https://github.com/flutter/flutter/pull/146348) merged on April 5, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/flutter/pull/146348) over 1 hour, 3 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] eliminate sub-render pass for blended color + texture vertices.
    <sub>[#51778](https://github.com/flutter/engine/pull/51778) merged on April 3, 2024 &mdash; **Medium:** [33 comments](https://github.com/flutter/engine/pull/51778) over 5 days, 363 additions and 3 deletions in 10 files</sub>
    <sub>Reviewed by: [gaaclarke](https://github.com/gaaclarke)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] fail CI if validations are enabled but not available.
    <sub>[#51378](https://github.com/flutter/engine/pull/51378) merged on April 5, 2024 &mdash; **Small:** [34 comments](https://github.com/flutter/engine/pull/51378) over 3 weeks, 25 additions and 4 deletions in 6 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Matan Lurey](https://github.com/matanlurey), [gaaclarke](https://github.com/gaaclarke)</sub>
...
* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "Replace `WindowInsetsController...` with `adb shell` commands (#51843)"
    <sub>[#51847](https://github.com/flutter/engine/pull/51847) merged on April 2, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/51847) over 1 minute, 25 additions and 17 deletions in 2 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>
    <sub><details><summary>2 images...</summary>![image](https://github.com/flutter/engine/assets/168174/14d46a7a-9b60-4c5d-b786-a6cbee823ef9)![image](https://github.com/flutter/engine/assets/168174/f4e49258-dcde-4864-b622-19c36c52f8b7)</details></sub>

* **[Chinmay Garde](https://github.com/chinmaygarde)** &mdash; Allow creating slimpeller engine variants.
    <sub>[#51824](https://github.com/flutter/engine/pull/51824) merged on April 2, 2024 &mdash; **Small:** [15 comments](https://github.com/flutter/engine/pull/51824) over 23 hours, 23 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey), [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; [et] Prepare local_engine.json for CI, teach et to understand local build names
    <sub>[#51803](https://github.com/flutter/engine/pull/51803) merged on April 3, 2024 &mdash; **Large:** [13 comments](https://github.com/flutter/engine/pull/51803) over 2 days, 694 additions and 106 deletions in 21 files</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey), [John McCutchan](https://github.com/johnmccutchan)</sub>

* **[John McCutchan](https://github.com/johnmccutchan)** &mdash; Expand understanding of build targets in et
    <sub>[#51868](https://github.com/flutter/engine/pull/51868) merged on April 4, 2024 &mdash; **Large:** [16 comments](https://github.com/flutter/engine/pull/51868) over 1 day, 417 additions and 249 deletions in 12 files</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey), [Zachary Anderson](https://github.com/zanderso), [Chris Bracken](https://github.com/cbracken)</sub>
...
* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Run `DrawSolidBlueScreenTest` 20x in a row in `bringup` (up from 5x)
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] handle fill polylines with zero area.
    <sub>[#51945](https://github.com/flutter/engine/pull/51945) merged on April 5, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/51945) over 41 minutes, 16 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey)</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] make color source a variant instead of a closure.
    <sub>[#51853](https://github.com/flutter/engine/pull/51853) merged on April 3, 2024 &mdash; **Medium:** [10 comments](https://github.com/flutter/engine/pull/51853) over 5 hours, 220 additions and 122 deletions in 2 files</sub>
    <sub>Reviewed by: [gaaclarke](https://github.com/gaaclarke)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Adds human readable descriptions to build configs
    <sub>[#51929](https://github.com/flutter/engine/pull/51929) merged on April 5, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/51929) over 17 hours, 120 additions and 1 deletion in 29 files</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [scenarios] dont do a weird invalidate on TextView.
    <sub>[#51866](https://github.com/flutter/engine/pull/51866) merged on April 3, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/51866) over 53 minutes, 0 additions and 12 deletions in 1 file</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey)</sub>
...
* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Return an empty optional in HardwareBuffer::GetSystemUniqueID if the underlying NDK API is unavailable
...
* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Manual Dart roll to 0ac840ba1 and update frontend server snapshot filename
    <sub>[#51921](https://github.com/flutter/engine/pull/51921) merged on April 4, 2024 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/51921) over 1 hour, 18 additions and 16 deletions in 8 files</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] dont inc shared_ptr count for every command/pipeline in render_pass_vk
    <sub>[#51874](https://github.com/flutter/engine/pull/51874) merged on April 4, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/51874) over 8 hours, 3 additions and 5 deletions in 2 files</sub>
    <sub>Reviewed by: [John McCutchan](https://github.com/johnmccutchan)</sub>

* **[Loïc Sharma](https://github.com/loic-sharma)** &mdash; [Windows] Move EGL surface creation
    <sub>[#51920](https://github.com/flutter/engine/pull/51920) merged on April 5, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/51920) over 1 day, 69 additions and 40 deletions in 3 files</sub>
...
* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Generate only one "Frame Request Pending" event for each pending call to BeginFrame
    <sub>[#51857](https://github.com/flutter/engine/pull/51857) merged on April 4, 2024 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/51857) over 1 day, 79 additions and 2 deletions in 3 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; [et] Fixup help text a bit
    <sub>[#51930](https://github.com/flutter/engine/pull/51930) merged on April 5, 2024 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/51930) over 13 hours, 22 additions and 14 deletions in 4 files</sub>
    <sub>Reviewed by: [Kevin Moore](https://github.com/kevmoo), [Matan Lurey](https://github.com/matanlurey)</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] delete unused code.
    <sub>[#51871](https://github.com/flutter/engine/pull/51871) merged on April 3, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/51871) over 1 hour, 0 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Matan Lurey](https://github.com/matanlurey), [gaaclarke](https://github.com/gaaclarke)</sub>

* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Remove log statements that did not help.
    <sub>[#51825](https://github.com/flutter/engine/pull/51825) merged on April 1, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/51825) over 36 minutes, 0 additions and 11 deletions in 3 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Use non-deprecated replacements for Android JUnit and test instrumentation
    <sub>[#51854](https://github.com/flutter/engine/pull/51854) merged on April 3, 2024 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/51854) over 5 hours, 15 additions and 15 deletions in 13 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Matan Lurey](https://github.com/matanlurey)** &mdash; Move scenario_app integration tests back to `max_attempts: 2`.
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] fix plus blend mode in porterduff shader.
    <sub>[#51792](https://github.com/flutter/engine/pull/51792) merged on April 2, 2024 &mdash; **Small:** [8 comments](https://github.com/flutter/engine/pull/51792) over 3 days, 54 additions and 6 deletions in 4 files</sub>
    <sub>Reviewed by: [gaaclarke](https://github.com/gaaclarke)</sub>
...
* **[John O'Neil](https://github.com/johnoneil)** &mdash; #145421 Fix glyph padding in STB atlas impl.
    <sub>[#51585](https://github.com/flutter/engine/pull/51585) merged on April 4, 2024 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/51585) over 2 weeks, 1 addition and 2 deletions in 1 file</sub>
...
* **[Tong Mu](https://github.com/dkwingsmt)** &mdash; Fix a memory error in a multithreaded test
    <sub>[#51951](https://github.com/flutter/engine/pull/51951) merged on April 5, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/51951) over 54 minutes, 7 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub>

* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "Remove #if SHELL_ENABLE_METAL checks in iOS code (#51636)"
    <sub>[#51941](https://github.com/flutter/engine/pull/51941) merged on April 5, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/51941) over 58 seconds, 51 additions and 17 deletions in 4 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "Manual Dart roll to 0ac840ba1 and update frontend server snapshot filename (#51921)"
    <sub>[#51927](https://github.com/flutter/engine/pull/51927) merged on April 5, 2024 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/51927) over 59 seconds, 16 additions and 18 deletions in 8 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[auto-submit](https://github.com/apps/auto-submit)** &mdash; Reverts "Roll Dart SDK from 0ac840ba1f0b to 31ddd6924103 (5 revisions) (#51924)"
    <sub>[#51926](https://github.com/flutter/engine/pull/51926) merged on April 5, 2024 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/51926) over 1 minute, 5 additions and 5 deletions in 3 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[Kaylee Lubick](https://github.com/kjlubick)** &mdash; Use moved GrBackendTexture factories for Skia's Metal backend
...
* **[Tong Mu](https://github.com/dkwingsmt)** &mdash; Multiview backing store
    <sub>[#51722](https://github.com/flutter/engine/pull/51722) merged on April 4, 2024 &mdash; **Small:** [9 comments](https://github.com/flutter/engine/pull/51722) over 1 week, 236 additions and 21 deletions in 9 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Chris Bracken](https://github.com/cbracken), [Loïc Sharma](https://github.com/loic-sharma)</sub>
...
* **[utzcoz](https://github.com/utzcoz)** &mdash; Bump Robolectric to 4.12.1
    <sub>[#51800](https://github.com/flutter/engine/pull/51800) merged on April 4, 2024 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/51800) over 5 days, 3 additions and 3 deletions in 3 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Gray Mackall](https://github.com/gmackall)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] reland foreground blend optimizaiton, fix advanced blend optimization.
    <sub>[#51938](https://github.com/flutter/engine/pull/51938) merged on April 5, 2024 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/51938) over 3 hours, 171 additions and 20 deletions in 5 files</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>
...
* **[Vladimir E. Koltunov](https://github.com/PROGrand)** &mdash; [camera] Camera with MediaSettings: platform implementations (federated)
    <sub>[#5223](https://github.com/flutter/packages/pull/5223) merged on April 5, 2024 &mdash; **Extra large:** [287 comments](https://github.com/flutter/packages/pull/5223) over 5 months, 2703 additions and 416 deletions in 67 files</sub>
    <sub>Reviewed by: [Maurice Parrish](https://github.com/bparrishMines), [stuartmorgan](https://github.com/stuartmorgan), [Jenn Magder](https://github.com/jmagman), [David Iglesias](https://github.com/ditman), [Camille Simon](https://github.com/camsim99)</sub>
...
* **[Tarrin Neal](https://github.com/tarrinneal)** &mdash; [pigeon] Allow multi instance support with message channel name suffix
    ...
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Maurice Parrish](https://github.com/bparrishMines), [hellohuanlin](https://github.com/hellohuanlin)</sub>
...
* **[Timm Preetz](https://github.com/tp)** &mdash; [video_player] Call `super.dispose` last in README example
    <sub>[#6051](https://github.com/flutter/packages/pull/6051) merged on April 5, 2024 &mdash; **Small:** [16 comments](https://github.com/flutter/packages/pull/6051) over 1 month, 7 additions and 3 deletions in 4 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[Reid Baker](https://github.com/reidbaker)** &mdash; [Tool] Add ability to check dependencies independently of dev-dependencies, exclude integration_test from dependencies
    <sub>[#6446](https://github.com/flutter/packages/pull/6446) merged on April 3, 2024 &mdash; **Small:** [17 comments](https://github.com/flutter/packages/pull/6446) over 2 days, 75 additions and 1 deletion in 2 files</sub>
