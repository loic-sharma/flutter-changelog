...
* **[Patrick Lindsay](https://github.com/lindsaypj)** &mdash; Added CupertinoDatepicker monthYear mode (flutter#93508)
    <sub>[#125603](https://github.com/flutter/flutter/pull/125603) merged on May 5, 2023 &mdash; **Large:** [11 comments](https://github.com/flutter/flutter/pull/125603) over 1 week, 515 additions and 8 deletions in 2 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc), [Mitchell Goodwin](https://github.com/MitchellGoodwin)</sub>
    <sub><details><summary>1 image...</summary>![monthYearMode](https://user-images.githubusercontent.com/98486346/234749274-794dce24-28c7-4f48-92ab-5ac46ec069d7.png)</details></sub>
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Introduce `TabBar.tabAlignment` 
    <sub>[#125036](https://github.com/flutter/flutter/pull/125036) merged on May 1, 2023 &mdash; **Medium:** [22 comments](https://github.com/flutter/flutter/pull/125036) over 1 week, 355 additions and 24 deletions in 5 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[Valentin Vignal](https://github.com/ValentinVignal)** &mdash; Align the Popup Menu under its child
    <sub>[#125534](https://github.com/flutter/flutter/pull/125534) merged on May 2, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/flutter/pull/125534) over 6 days, 44 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks), [Qun Cheng](https://github.com/QuncCccccc)</sub>
    <sub><details><summary>2 images...</summary>![image](https://user-images.githubusercontent.com/32538273/234468262-beddb257-5f5a-422f-a678-c26efc52dc07.png)![image](https://user-images.githubusercontent.com/32538273/234468233-3ea4d741-b04c-4012-bdd7-a36ecedc029c.png)</details></sub>

* **[Qun Cheng](https://github.com/QuncCccccc)** &mdash; Add `Switch.trackOutlineWidth` property
    <sub>[#125848](https://github.com/flutter/flutter/pull/125848) merged on May 5, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/flutter/pull/125848) over 3 days, 274 additions and 23 deletions in 5 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>
    <sub><details><summary>2 images...</summary><img width="77" alt="Screenshot 2023-05-01 at 12 24 16 PM" src="https://user-images.githubusercontent.com/36861262/235552215-64898686-341d-43f9-8ebd-ce24e13d6f70.png"><img width="77" alt="Screenshot 2023-05-01 at 12 24 04 PM" src="https://user-images.githubusercontent.com/36861262/235552248-d2d89dc4-9792-483a-a83a-af11de0895ff.png"></details></sub>

* **[Pierre-Louis](https://github.com/guidezpl)** &mdash; Provide default constraints for M3 dialogs
    <sub>[#120082](https://github.com/flutter/flutter/pull/120082) merged on May 4, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/120082) over 2 months, 63 additions and 31 deletions in 3 files</sub>
    <sub>Reviewed by: [Eilidh Southren](https://github.com/esouthren), [hangyu](https://github.com/hangyujin)</sub>

* **[gmackall](https://github.com/gmackall)** &mdash; Revert "Add migrator to upgrade gradle version when conflict with And…
    <sub>[#125813](https://github.com/flutter/flutter/pull/125813) merged on May 1, 2023 &mdash; **Large:** [0 comments](https://github.com/flutter/flutter/pull/125813) over 49 minutes, 40 additions and 515 deletions in 22 files</sub>
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker)</sub>

* **[Loïc Sharma](https://github.com/loic-sharma)** &mdash; Add Windows and Linux support to the 'layers' example
    <sub>[#126105](https://github.com/flutter/flutter/pull/126105) merged on May 6, 2023 &mdash; **Large:** [5 comments](https://github.com/flutter/flutter/pull/126105) over 1 day, 1453 additions and 6 deletions in 22 files</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog), [yaakovschectman](https://github.com/yaakovschectman)</sub>

* **[Viren Khatri](https://github.com/werainkhatri)** &mdash; add tests for dominant bottom sheet in scaffold
    <sub>[#124472](https://github.com/flutter/flutter/pull/124472) merged on May 5, 2023 &mdash; **Small:** [19 comments](https://github.com/flutter/flutter/pull/124472) over 3 weeks, 93 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix Material 3 tab indicator weight and position
    <sub>[#125883](https://github.com/flutter/flutter/pull/125883) merged on May 5, 2023 &mdash; **Medium:** [10 comments](https://github.com/flutter/flutter/pull/125883) over 2 days, 430 additions and 15 deletions in 5 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[Andrew Kolos](https://github.com/andrewkolos)** &mdash; [tools] Apply Android Studio version detection logic to explicitly configured installation directory (`flutter config --android-studio-dir`)
    <sub>[#125596](https://github.com/flutter/flutter/pull/125596) merged on May 1, 2023 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/125596) over 4 days, 170 additions and 34 deletions in 2 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[林洵锋](https://github.com/LinXunFeng)** &mdash; [ios] fix hold and drag spacebar does not move cursor when obscureTex…
    <sub>[#122383](https://github.com/flutter/flutter/pull/122383) merged on May 6, 2023 &mdash; **Small:** [11 comments](https://github.com/flutter/flutter/pull/122383) over 1 month, 42 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc), [Chris Yang](https://github.com/cyanglaz)</sub>

* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Use direct dart API from `dart:ui_web` rather than JS shim.
    <sub>[#123443](https://github.com/flutter/flutter/pull/123443) merged on May 5, 2023 &mdash; **Medium:** [16 comments](https://github.com/flutter/flutter/pull/123443) over 1 month, 174 additions and 270 deletions in 9 files</sub>
    <sub>Reviewed by: [Kevin Moore](https://github.com/kevmoo), [sigmundch](https://github.com/sigmundch), [Jonah Williams](https://github.com/jonahwilliams), [Mouad Debbar](https://github.com/mdebbar)</sub>

* **[fzyzcjy](https://github.com/fzyzcjy)** &mdash; `ModalBarrier`'s gesture recognizer does not call `invokeCallback`
    <sub>[#125386](https://github.com/flutter/flutter/pull/125386) merged on May 3, 2023 &mdash; **Small:** [19 comments](https://github.com/flutter/flutter/pull/125386) over 1 week, 27 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer), [chunhtai](https://github.com/chunhtai)</sub>

* **[Nate Bosch](https://github.com/natebosch)** &mdash; Switch imports from test_api to focused libaries
    <sub>[#125854](https://github.com/flutter/flutter/pull/125854) merged on May 4, 2023 &mdash; **Small:** [13 comments](https://github.com/flutter/flutter/pull/125854) over 2 days, 9 additions and 17 deletions in 7 files</sub>
...
* **[Alberto Azinar](https://github.com/albertoazinar)** &mdash; improvement : removed required  kotlin dependency
    <sub>[#125002](https://github.com/flutter/flutter/pull/125002) merged on May 5, 2023 &mdash; **Small:** [9 comments](https://github.com/flutter/flutter/pull/125002) over 2 weeks, 1 addition and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker), [Andrew Kolos](https://github.com/andrewkolos)</sub>

* **[LongCatIsLooong](https://github.com/LongCatIsLooong)** &mdash; Add `InlineSpan.visitDirectChildren`
...
* **[Istiak Ahmed](https://github.com/Istiak-Ahmed78)** &mdash; Add sample code for SliverAppBar
    <sub>[#125785](https://github.com/flutter/flutter/pull/125785) merged on May 5, 2023 &mdash; **Small:** [18 comments](https://github.com/flutter/flutter/pull/125785) over 4 days, 143 additions and 0 deletions in 3 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc), [Kate Lovett](https://github.com/Piinks)</sub>

* **[chunhtai](https://github.com/chunhtai)** &mdash; Cleans up appbar imply leading logic
    <sub>[#125315](https://github.com/flutter/flutter/pull/125315) merged on May 4, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125315) over 1 week, 28 additions and 5 deletions in 2 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; [tool] Improve help info with build web --wasm flags
    <sub>[#125907](https://github.com/flutter/flutter/pull/125907) merged on May 3, 2023 &mdash; **Small:** [12 comments](https://github.com/flutter/flutter/pull/125907) over 1 day, 9 additions and 4 deletions in 2 files</sub>
    <sub>Reviewed by: [Yegor](https://github.com/yjbanov)</sub>

* **[Alex Li](https://github.com/AlexV525)** &mdash; ✨ Add `rect` argument to `_ArcPaintPredicate` for tests
    <sub>[#125953](https://github.com/flutter/flutter/pull/125953) merged on May 6, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/125953) over 2 days, 23 additions and 4 deletions in 1 file</sub>
    <sub>Reviewed by: [pdblasi-google](https://github.com/pdblasi-google)</sub>

* **[Ian Hickson](https://github.com/Hixie)** &mdash; Minor fixes found while working on blankcanvas
    <sub>[#125751](https://github.com/flutter/flutter/pull/125751) merged on May 5, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125751) over 5 days, 95 additions and 46 deletions in 9 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer)</sub>
...
* **[Elias Yishak](https://github.com/eliasyishak)** &mdash; Adding printOnFailure for result of process
    <sub>[#125910](https://github.com/flutter/flutter/pull/125910) merged on May 3, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125910) over 18 hours, 16 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>
...
* **[Loïc Sharma](https://github.com/loic-sharma)** &mdash; Clarify Visual Studio isn't strictly necessary for Windows development
    <sub>[#125837](https://github.com/flutter/flutter/pull/125837) merged on May 2, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125837) over 22 hours, 2 additions and 2 deletions in 2 files</sub>
...
* **[Jenn Magder](https://github.com/jmagman)** &mdash; Mark microbenchmarks_ios unflaky
    <sub>[#125332](https://github.com/flutter/flutter/pull/125332) merged on May 2, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125332) over 1 week, 0 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer), [Christopher Fujino](https://github.com/christopherfujino)</sub>
...
* **[Bruno Leroux](https://github.com/bleroux)** &mdash; Add a ReorderableListView example with cards + cleanup existing tests
    <sub>[#126155](https://github.com/flutter/flutter/pull/126155) merged on May 5, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/126155) over 3 hours, 214 additions and 79 deletions in 9 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool: replace top-level functions with enum properties
    <sub>[#126167](https://github.com/flutter/flutter/pull/126167) merged on May 5, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/126167) over 1 hour, 130 additions and 151 deletions in 20 files</sub>
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker)</sub>

* **[Drew Roen](https://github.com/drewroengoogle)** &mdash; Bring back the failing build_test's
    <sub>[#126014](https://github.com/flutter/flutter/pull/126014) merged on May 5, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/flutter/pull/126014) over 1 day, 0 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [godofredoc](https://github.com/godofredoc)</sub>

* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Use plain platform views in benchmarks
    <sub>[#126080](https://github.com/flutter/flutter/pull/126080) merged on May 5, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/126080) over 20 hours, 142 additions and 103 deletions in 6 files</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool: use switch expressions
    <sub>[#125930](https://github.com/flutter/flutter/pull/125930) merged on May 3, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125930) over 20 hours, 61 additions and 102 deletions in 6 files</sub>
    <sub>Reviewed by: [Jacob Richman](https://github.com/jacob314)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool-web: use ProcessUtil.run to invoke child processes
    <sub>[#126109](https://github.com/flutter/flutter/pull/126109) merged on May 5, 2023 &mdash; **Small:** [9 comments](https://github.com/flutter/flutter/pull/126109) over 2 hours, 38 additions and 42 deletions in 1 file</sub>
    <sub>Reviewed by: [Ian Hickson](https://github.com/Hixie), [Yegor](https://github.com/yjbanov), [Harry Terkelsen](https://github.com/hterkelsen)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Mark build_test builds as bringup.
    <sub>[#125898](https://github.com/flutter/flutter/pull/125898) merged on May 2, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/flutter/pull/125898) over 56 minutes, 6 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Drew Roen](https://github.com/drewroengoogle), [keyonghan](https://github.com/keyonghan)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool-web-wasm: make wasm-opt an "option" instead of a "flag"
    <sub>[#126035](https://github.com/flutter/flutter/pull/126035) merged on May 4, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/126035) over 20 hours, 122 additions and 26 deletions in 5 files</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>
...
* **[Kevin Moore](https://github.com/kevmoo)** &mdash; targets/web.dart - fix typo
    <sub>[#126114](https://github.com/flutter/flutter/pull/126114) merged on May 5, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/126114) over 22 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman)</sub>

* **[Casey Rogers](https://github.com/caseycrogers)** &mdash; Make `future` and `stream` required arguments in their respective builder widgets
    <sub>[#125838](https://github.com/flutter/flutter/pull/125838) merged on May 2, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/125838) over 10 hours, 14 additions and 11 deletions in 2 files</sub>
    <sub>Reviewed by: [Brett Morgan](https://github.com/domesticmouse), [Michael Goderbauer](https://github.com/goderbauer)</sub>

* **[chunhtai](https://github.com/chunhtai)** &mdash; Rename iosdeeplinksettings to iosuniversallinksettings
    <sub>[#126173](https://github.com/flutter/flutter/pull/126173) merged on May 5, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/126173) over 1 hour, 5 additions and 5 deletions in 2 files</sub>
    <sub>Reviewed by: [Victoria Ashworth](https://github.com/vashworth)</sub>

* **[ChenRenJie](https://github.com/b7woreo)** &mdash; Fix incorrect assert hint in flutter.groovy
    <sub>[#125283](https://github.com/flutter/flutter/pull/125283) merged on May 5, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125283) over 2 weeks, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Bartek Pacia](https://github.com/bartekpacia), [Reid Baker](https://github.com/reidbaker)</sub>

* **[Andrew Kolos](https://github.com/andrewkolos)** &mdash; [tools] fix `expect` calls in `FakeCommand`
    <sub>[#125783](https://github.com/flutter/flutter/pull/125783) merged on May 1, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125783) over 11 hours, 3 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool: DRY up DepfileService
    <sub>[#125922](https://github.com/flutter/flutter/pull/125922) merged on May 3, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/125922) over 21 hours, 38 additions and 120 deletions in 16 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Drew Roen](https://github.com/drewroengoogle)** &mdash; Update .cirrus.yml
    <sub>[#126166](https://github.com/flutter/flutter/pull/126166) merged on May 5, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/126166) over 2 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; add slsa l1 badge
    <sub>[#125932](https://github.com/flutter/flutter/pull/125932) merged on May 3, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125932) over 19 hours, 1 addition and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Drew Roen](https://github.com/drewroengoogle)</sub>

* **[gmackall](https://github.com/gmackall)** &mdash; [Reland] Add migrator to upgrade gradle version when conflict with Android Studio bundled Java version is detected
    <sub>[#125836](https://github.com/flutter/flutter/pull/125836) merged on May 3, 2023 &mdash; **Large:** [10 comments](https://github.com/flutter/flutter/pull/125836) over 1 day, 583 additions and 41 deletions in 23 files</sub>
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix `SliverAppBar.medium` & `SliverAppBar.large` text scale
    <sub>[#125038](https://github.com/flutter/flutter/pull/125038) merged on April 25, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/flutter/pull/125038) over 6 days, 214 additions and 19 deletions in 2 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>
...
* **[Justin McCandless](https://github.com/justinmc)** &mdash; iOS TextField spell check style
    <sub>[#125432](https://github.com/flutter/flutter/pull/125432) merged on April 25, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125432) over 23 hours, 119 additions and 25 deletions in 3 files</sub>
...
* **[Qun Cheng](https://github.com/QuncCccccc)** &mdash; `Checkbox.fillColor` should be applied to checkbox's background color when it is unchecked.
    <sub>[#125643](https://github.com/flutter/flutter/pull/125643) merged on April 28, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/125643) over 1 day, 206 additions and 61 deletions in 4 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>
...
* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Fix `SnackBar` material clip
    <sub>[#125622](https://github.com/flutter/flutter/pull/125622) merged on April 27, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125622) over 4 hours, 45 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>
...
* **[Tirth](https://github.com/piedcipher)** &mdash; [date_picker] [date_range_picker] add properties to change switch-to icons
    <sub>[#124881](https://github.com/flutter/flutter/pull/124881) merged on April 24, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/124881) over 1 week, 275 additions and 6 deletions in 3 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>
...
* **[Viren Khatri](https://github.com/werainkhatri)** &mdash; enhances OverlayEntry docs
    <sub>[#124478](https://github.com/flutter/flutter/pull/124478) merged on April 28, 2023 &mdash; **Small:** [21 comments](https://github.com/flutter/flutter/pull/124478) over 2 weeks, 16 additions and 8 deletions in 1 file</sub>
...
* **[Tae Hyung Kim](https://github.com/thkim1011)** &mdash; Sliver Constrained Cross Axis
    <sub>[#125239](https://github.com/flutter/flutter/pull/125239) merged on April 24, 2023 &mdash; **Medium:** [19 comments](https://github.com/flutter/flutter/pull/125239) over 4 days, 350 additions and 0 deletions in 6 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[Pierre-Louis](https://github.com/guidezpl)** &mdash; Provide default constraints for M3 bottom sheets
...
* **[chunhtai](https://github.com/chunhtai)** &mdash; Adds selected semantics flag to radio button for Apple devices
    <sub>[#125499](https://github.com/flutter/flutter/pull/125499) merged on April 25, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125499) over 3 hours, 100 additions and 0 deletions in 4 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[yaakovschectman](https://github.com/yaakovschectman)** &mdash; Opt into CMake policy CMP0135
    <sub>[#125502](https://github.com/flutter/flutter/pull/125502) merged on April 28, 2023 &mdash; **Small:** [28 comments](https://github.com/flutter/flutter/pull/125502) over 3 days, 15 additions and 11 deletions in 12 files</sub>
...
* **[Bruno Leroux](https://github.com/bleroux)** &mdash; Add a channel to query the engine keyboard state
    <sub>[#122885](https://github.com/flutter/flutter/pull/122885) merged on April 28, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/flutter/pull/122885) over 1 month, 67 additions and 5 deletions in 6 files</sub>
    <sub>Reviewed by: [Tong Mu](https://github.com/dkwingsmt)</sub>
...
* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Add back one Skia test on iOS
    <sub>[#125663](https://github.com/flutter/flutter/pull/125663) merged on April 28, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125663) over 15 hours, 44 additions and 182 deletions in 19 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Taha Tesser](https://github.com/TahaTesser)** &mdash; Add `slider_perf_android` task to `ci.yaml`
    <sub>[#125540](https://github.com/flutter/flutter/pull/125540) merged on April 27, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125540) over 1 day, 11 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[Christopher Fujino](https://github.com/christopherfujino)** &mdash; [flutter_tools] more debugging for timeouts in break_on_framework_exceptions test
    <sub>[#125584](https://github.com/flutter/flutter/pull/125584) merged on April 27, 2023 &mdash; **Small:** [7 comments](https://github.com/flutter/flutter/pull/125584) over 21 hours, 81 additions and 174 deletions in 2 files</sub>
    <sub>Reviewed by: [Elias Yishak](https://github.com/eliasyishak)</sub>

* **[Jenn Magder](https://github.com/jmagman)** &mdash; Mark module_test_ios tests unflaky
    <sub>[#125498](https://github.com/flutter/flutter/pull/125498) merged on April 27, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125498) over 2 days, 0 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan), [Victoria Ashworth](https://github.com/vashworth)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Remove flavors_test_macos
...
* **[Phlippie Bosman](https://github.com/phlippieb-discovery)** &mdash; Nit: grammar in documentation
    <sub>[#125462](https://github.com/flutter/flutter/pull/125462) merged on April 28, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/125462) over 3 days, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller), [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Reid Baker](https://github.com/reidbaker)** &mdash; Smallest change required to support host apps using agp 8.0
    <sub>[#125657](https://github.com/flutter/flutter/pull/125657) merged on April 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125657) over 14 hours, 8 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [gmackall](https://github.com/gmackall), [Camille Simon](https://github.com/camsim99)</sub>

* **[Janice Collins](https://github.com/jcollins-g)** &mdash; Update dartdoc to v6.2.2.
    <sub>[#125650](https://github.com/flutter/flutter/pull/125650) merged on April 27, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125650) over 1 hour, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[fzyzcjy](https://github.com/fzyzcjy)** &mdash; fix: `moreOrLessEquals` does not allow `actual` to be integers
    <sub>[#125599](https://github.com/flutter/flutter/pull/125599) merged on April 27, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125599) over 11 hours, 4 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams), [Viren Khatri](https://github.com/werainkhatri)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tools: Drop unused function
    <sub>[#125590](https://github.com/flutter/flutter/pull/125590) merged on April 27, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/flutter/pull/125590) over 4 hours, 0 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[Kevin Moore](https://github.com/kevmoo)** &mdash; tool: Move cdKey to CustomDimensionsEnum
    <sub>[#125335](https://github.com/flutter/flutter/pull/125335) merged on April 24, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125335) over 3 days, 71 additions and 68 deletions in 3 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>
...
* **[Mitchell Goodwin](https://github.com/MitchellGoodwin)** &mdash; Adaptive alert dialog
    ...
    <sub>Reviewed by: [Qun Cheng](https://github.com/QuncCccccc), [Viren Khatri](https://github.com/werainkhatri)</sub>
...
* **[Bartek Pacia](https://github.com/bartekpacia)** &mdash; Refactor Flutter Gradle Plugin so it can be applied using the declarative `plugins {}` block
    <sub>[#123511](https://github.com/flutter/flutter/pull/123511) merged on April 19, 2023 &mdash; **Extra large:** [94 comments](https://github.com/flutter/flutter/pull/123511) over 3 weeks, 1444 additions and 1373 deletions in 12 files</sub>
    <sub>Reviewed by: [Greg Price](https://github.com/gnprice)</sub>

* **[Greg Spencer](https://github.com/gspencergoog)** &mdash; Update the copy icon in snippets and samples to use the standard one
    <sub>[#123651](https://github.com/flutter/flutter/pull/123651) merged on April 18, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/123651) over 2 weeks, 2 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer)</sub>
...
* **[Luccas Clezar](https://github.com/luccasclezar)** &mdash; Update Cupertino desktop text selection toolbar
    <sub>[#121829](https://github.com/flutter/flutter/pull/121829) merged on April 21, 2023 &mdash; **Medium:** [46 comments](https://github.com/flutter/flutter/pull/121829) over 1 month, 278 additions and 66 deletions in 7 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc), [Mitchell Goodwin](https://github.com/MitchellGoodwin)</sub>
...
* **[chunhtai](https://github.com/chunhtai)** &mdash; Add vmservice for android build options
    <sub>[#123034](https://github.com/flutter/flutter/pull/123034) merged on April 18, 2023 &mdash; **Medium:** [61 comments](https://github.com/flutter/flutter/pull/123034) over 4 weeks, 409 additions and 73 deletions in 19 files</sub>
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker), [Andrew Kolos](https://github.com/andrewkolos)</sub>

* **[Justin McCandless](https://github.com/justinmc)** &mdash; Red spell check selection on iOS
    <sub>[#125162](https://github.com/flutter/flutter/pull/125162) merged on April 21, 2023 &mdash; **Small:** [12 comments](https://github.com/flutter/flutter/pull/125162) over 1 day, 129 additions and 12 deletions in 6 files</sub>
    <sub>Reviewed by: [Mitchell Goodwin](https://github.com/MitchellGoodwin), [Camille Simon](https://github.com/camsim99)</sub>
...
* **[Nabeel Parkar](https://github.com/exaby73)** &mdash; Migrate new feature issue template to GitHub forms
    <sub>[#123682](https://github.com/flutter/flutter/pull/123682) merged on April 22, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/123682) over 3 weeks, 53 additions and 49 deletions in 2 files</sub>
...
* **[Justin McCandless](https://github.com/justinmc)** &mdash; iOS spell check cursor placement
    <sub>[#124875](https://github.com/flutter/flutter/pull/124875) merged on April 18, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/124875) over 3 days, 122 additions and 5 deletions in 2 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>
...
* **[Justin McCandless](https://github.com/justinmc)** &mdash; Limit the number of Material spell check suggestions to 3
    <sub>[#124899](https://github.com/flutter/flutter/pull/124899) merged on April 18, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/124899) over 3 days, 147 additions and 55 deletions in 4 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>
...
* **[Justin McCandless](https://github.com/justinmc)** &mdash; Disableable ContextMenuButtonItems
    <sub>[#124253](https://github.com/flutter/flutter/pull/124253) merged on April 19, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/124253) over 1 week, 129 additions and 16 deletions in 10 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>
...
* **[Justin McCandless](https://github.com/justinmc)** &mdash; Show iOS menu on iOS for TextField by default
    <sub>[#124895](https://github.com/flutter/flutter/pull/124895) merged on April 20, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/124895) over 5 days, 122 additions and 30 deletions in 5 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>
...
* **[Samuel Abada](https://github.com/Mastersam07)** &mdash; Remove double.fromEnvironment from dart-define doc
    <sub>[#124102](https://github.com/flutter/flutter/pull/124102) merged on April 18, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/flutter/pull/124102) over 2 weeks, 3 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino), [Andrew Kolos](https://github.com/andrewkolos)</sub>
...
* **[Bruno Leroux](https://github.com/bleroux)** &mdash; Make selectable text mouse cursor configurable
    <sub>[#125133](https://github.com/flutter/flutter/pull/125133) merged on April 21, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/flutter/pull/125133) over 2 days, 204 additions and 21 deletions in 9 files</sub>
    <sub>Reviewed by: [Pierre-Louis](https://github.com/guidezpl)</sub>

* **[Kate Lovett](https://github.com/Piinks)** &mdash; Fix text theme dart fix cases
...
* **[Michael Thomsen](https://github.com/mit-mit)** &mdash; Cleanup flutter config output
    <sub>[#122384](https://github.com/flutter/flutter/pull/122384) merged on April 21, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/flutter/pull/122384) over 1 month, 9 additions and 18 deletions in 2 files</sub>
    <sub>Reviewed by: [Elias Yishak](https://github.com/eliasyishak)</sub>

* **[9oya](https://github.com/9oya)** &mdash; Implement CheckmarkableChipAttributes on ChoiceChip
    <sub>[#124743](https://github.com/flutter/flutter/pull/124743) merged on April 20, 2023 &mdash; **Small:** [20 comments](https://github.com/flutter/flutter/pull/124743) over 1 week, 42 additions and 1 deletion in 3 files</sub>
...
* **[Andrew Kolos](https://github.com/andrewkolos)** &mdash; When searching for the JDK bundled with an unrecognized version of Android Studio, assume the version to be the latest
    <sub>[#125247](https://github.com/flutter/flutter/pull/125247) merged on April 21, 2023 &mdash; **Medium:** [8 comments](https://github.com/flutter/flutter/pull/125247) over 4 hours, 260 additions and 89 deletions in 2 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Kevin Moore](https://github.com/kevmoo)** &mdash; Report web compiler used with `buildEventSettings`
    <sub>[#125092](https://github.com/flutter/flutter/pull/125092) merged on April 19, 2023 &mdash; **Small:** [14 comments](https://github.com/flutter/flutter/pull/125092) over 18 hours, 17 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso), [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Ben Konyi](https://github.com/bkonyi)** &mdash; Fix race condition in flutter test when passing --serve-observatory
    <sub>[#123556](https://github.com/flutter/flutter/pull/123556) merged on April 20, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/flutter/pull/123556) over 3 weeks, 35 additions and 13 deletions in 2 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>
...
* **[chunhtai](https://github.com/chunhtai)** &mdash; Remove unecessary reference to ClipboardStatusNotifier
    <sub>[#125255](https://github.com/flutter/flutter/pull/125255) merged on April 21, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125255) over 1 day, 26 additions and 40 deletions in 10 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc)</sub>

* **[Callum Moffat](https://github.com/moffatman)** &mdash; Adjust selection rects inclusion criteria
    <sub>[#125022](https://github.com/flutter/flutter/pull/125022) merged on April 22, 2023 &mdash; **Small:** [15 comments](https://github.com/flutter/flutter/pull/125022) over 3 days, 79 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [hellohuanlin](https://github.com/hellohuanlin), [LongCatIsLooong](https://github.com/LongCatIsLooong)</sub>

* **[chunhtai](https://github.com/chunhtai)** &mdash; MinimumTapTargetGuideline skips nodes at scrollable boundaries
    <sub>[#124615](https://github.com/flutter/flutter/pull/124615) merged on April 20, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/flutter/pull/124615) over 1 week, 61 additions and 10 deletions in 2 files</sub>
    <sub>Reviewed by: [pdblasi-google](https://github.com/pdblasi-google)</sub>

* **[xubaolin](https://github.com/xu-baolin)** &mdash; `DropdownMenu.width` should support updating at runtime
    <sub>[#124847](https://github.com/flutter/flutter/pull/124847) merged on April 20, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/124847) over 6 days, 38 additions and 3 deletions in 2 files</sub>
...
* **[Christopher Fujino](https://github.com/christopherfujino)** &mdash; [flutter_tools] make overall_experience_test resilient to extraneous pub output
    <sub>[#125172](https://github.com/flutter/flutter/pull/125172) merged on April 20, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125172) over 18 hours, 2 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks)</sub>

* **[Jenn Magder](https://github.com/jmagman)** &mdash; Combine `flutter_tool_startup` devicelab tests
    <sub>[#125226](https://github.com/flutter/flutter/pull/125226) merged on April 21, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125226) over 1 day, 3 additions and 23 deletions in 4 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>
...
* **[Nate Bosch](https://github.com/natebosch)** &mdash; Remove some ignores for un-deprecated imports
    <sub>[#125261](https://github.com/flutter/flutter/pull/125261) merged on April 22, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125261) over 1 day, 1 addition and 4 deletions in 2 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Justin McCandless](https://github.com/justinmc)** &mdash; Remove unused context parameter
    <sub>[#124254](https://github.com/flutter/flutter/pull/124254) merged on April 18, 2023 &mdash; **Small:** [9 comments](https://github.com/flutter/flutter/pull/124254) over 1 week, 88 additions and 6 deletions in 6 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>

* **[Christopher Fujino](https://github.com/christopherfujino)** &mdash; add gradle error handler for when the remote ssl host terminates handshake process
    <sub>[#125270](https://github.com/flutter/flutter/pull/125270) merged on April 21, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125270) over 20 hours, 67 additions and 0 deletions in 3 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Ian Hickson](https://github.com/Hixie)** &mdash; Remove dynamic calls
    <sub>[#125238](https://github.com/flutter/flutter/pull/125238) merged on April 20, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125238) over 59 minutes, 4 additions and 8 deletions in 1 file</sub>
    <sub>Reviewed by: [Greg Spencer](https://github.com/gspencergoog)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Stop running "_impeller_" benchmark variants
    <sub>[#125044](https://github.com/flutter/flutter/pull/125044) merged on April 18, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125044) over 1 hour, 0 additions and 109 deletions in 1 file</sub>
...
* **[Polina Cherkasova](https://github.com/polina-c)** &mdash; Upgrade leak_tracker.
    <sub>[#125272](https://github.com/flutter/flutter/pull/125272) merged on April 21, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/flutter/pull/125272) over 18 hours, 2 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Kenzie Davisson](https://github.com/kenzieschmoll)</sub>
...
* **[Hans Muller](https://github.com/HansMuller)** &mdash; Updated the BottomNavigationBar API doc to link to NavigationBar
    <sub>[#125240](https://github.com/flutter/flutter/pull/125240) merged on April 20, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125240) over 3 hours, 16 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Qun Cheng](https://github.com/QuncCccccc)</sub>
...
* **[Greg Spencer](https://github.com/gspencergoog)** &mdash; Add docs for kIsWeb on defaultTargetPlatform
    <sub>[#125313](https://github.com/flutter/flutter/pull/125313) merged on April 21, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125313) over 2 hours, 15 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [chunhtai](https://github.com/chunhtai)</sub>
...
* **[Renzo Olivares](https://github.com/Renzo-Olivares)** &mdash; Show magnifier on touch drag gestures
    <sub>[#125151](https://github.com/flutter/flutter/pull/125151) merged on April 20, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125151) over 11 hours, 253 additions and 35 deletions in 4 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc)</sub>

* **[keyonghan](https://github.com/keyonghan)** &mdash; Update xcode to 14c18 for host only bots
    <sub>[#125211](https://github.com/flutter/flutter/pull/125211) merged on April 21, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/flutter/pull/125211) over 12 hours, 43 additions and 43 deletions in 1 file</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman)</sub>
...
* **[Hugo](https://github.com/xcc3641)** &mdash; Fix the divider_theme space documentation problem
    <sub>[#125195](https://github.com/flutter/flutter/pull/125195) merged on April 21, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125195) over 1 day, 1 addition and 1 deletion in 1 file</sub>
...
* **[Kevin Moore](https://github.com/kevmoo)** &mdash; [tool,web] track web-renderer, and Wasm build args in analytics
    <sub>[#125336](https://github.com/flutter/flutter/pull/125336) merged on April 21, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125336) over 1 hour, 36 additions and 2 deletions in 3 files</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>

* **[Tae Hyung Kim](https://github.com/thkim1011)** &mdash; l10n.yaml's nullable-getter option should default to true
    <sub>[#124353](https://github.com/flutter/flutter/pull/124353) merged on April 18, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/flutter/pull/124353) over 1 week, 33 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>
...
* **[Greg Spencer](https://github.com/gspencergoog)** &mdash; Add controller argument to SubmenuButton
    ...
    <sub>Reviewed by: [damien saint macary](https://github.com/saintmac-google), [Qun Cheng](https://github.com/QuncCccccc)</sub>

* **[Qun Cheng](https://github.com/QuncCccccc)** &mdash; Dismiss the docked search view when the window size is changed
    <sub>[#125071](https://github.com/flutter/flutter/pull/125071) merged on April 19, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/flutter/pull/125071) over 20 hours, 98 additions and 38 deletions in 2 files</sub>
    <sub>Reviewed by: [Hans Muller](https://github.com/HansMuller)</sub>

* **[chunhtai](https://github.com/chunhtai)** &mdash; fix SliverReorderableList test to use correct custom action id
...
* **[Renzo Olivares](https://github.com/Renzo-Olivares)** &mdash; Toolbar should re-appear on drag end
    <sub>[#125165](https://github.com/flutter/flutter/pull/125165) merged on April 20, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125165) over 1 day, 18 additions and 0 deletions in 3 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc)</sub>

* **[chunhtai](https://github.com/chunhtai)** &mdash; fix localization typo for expansionTileExpandedHint
    <sub>[#125212](https://github.com/flutter/flutter/pull/125212) merged on April 20, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125212) over 2 hours, 10 additions and 2 deletions in 3 files</sub>
    <sub>Reviewed by: [Tae Hyung Kim](https://github.com/thkim1011)</sub>

* **[Reid Baker](https://github.com/reidbaker)** &mdash; i125138 abstract method smoke agp update
    <sub>[#125139](https://github.com/flutter/flutter/pull/125139) merged on April 20, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/flutter/pull/125139) over 23 hours, 148 additions and 106 deletions in 5 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>

* **[Casey Hillers](https://github.com/CaseyHillers)** &mdash; [ci.yaml] Remove unnecessary use of {
    <sub>[#125058](https://github.com/flutter/flutter/pull/125058) merged on April 21, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125058) over 2 days, 3 additions and 4 deletions in 1 file</sub>
...
* **[Tae Hyung Kim](https://github.com/thkim1011)** &mdash; Revert "Sliver Constrained Cross Axis"
    <sub>[#125233](https://github.com/flutter/flutter/pull/125233) merged on April 20, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/125233) over 4 minutes, 0 additions and 238 deletions in 5 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks), [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Revert "Update helper message for `--suppress-analytics`"
    <sub>[#125141](https://github.com/flutter/flutter/pull/125141) merged on April 19, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/flutter/pull/125141) over 2 minutes, 39 additions and 7 deletions in 3 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [cupertino] improve cupertino picker performance by using at most one opacity layer
    <sub>[#124719](https://github.com/flutter/flutter/pull/124719) merged on April 15, 2023 &mdash; **Small:** [23 comments](https://github.com/flutter/flutter/pull/124719) over 3 days, 91 additions and 44 deletions in 2 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer)</sub>
...
* **[Andrew Kolos](https://github.com/andrewkolos)** &mdash; [flutter_tools] Remove `Version.unknown`
    <sub>[#124771](https://github.com/flutter/flutter/pull/124771) merged on April 15, 2023 &mdash; **Medium:** [27 comments](https://github.com/flutter/flutter/pull/124771) over 2 days, 266 additions and 67 deletions in 11 files</sub>
    <sub>Reviewed by: [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; Revert "[framework] use shader tiling instead of repeated calls to drawImage"
    <sub>[#124640](https://github.com/flutter/flutter/pull/124640) merged on April 15, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/flutter/pull/124640) over 3 days, 110 additions and 160 deletions in 4 files</sub>
    <sub>Reviewed by: [Michael Goderbauer](https://github.com/goderbauer)</sub>
...
* **[Dan Field](https://github.com/dnfield)** &mdash; Add a `Display` API to dart:ui that reports the physical size, DPR, and refresh rate of the main display
    <sub>[#41685](https://github.com/flutter/engine/pull/41685) merged on May 6, 2023 &mdash; **Large:** [37 comments](https://github.com/flutter/engine/pull/41685) over 3 days, 703 additions and 167 deletions in 60 files</sub>
    <sub>Reviewed by: [Loïc Sharma](https://github.com/loic-sharma), [Michael Goderbauer](https://github.com/goderbauer), [Reid Baker](https://github.com/reidbaker)</sub>

* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Skwasm Font Loading
    <sub>[#41246](https://github.com/flutter/engine/pull/41246) merged on May 4, 2023 &mdash; **Extra large:** [8 comments](https://github.com/flutter/engine/pull/41246) over 2 weeks, 1401 additions and 913 deletions in 117 files</sub>
    <sub>Reviewed by: [Kevin Moore](https://github.com/kevmoo), [Harry Terkelsen](https://github.com/hterkelsen)</sub>
...
* **[Tong Mu](https://github.com/dkwingsmt)** &mdash; Remove single window assumption from SceneBuilder
    <sub>[#41559](https://github.com/flutter/engine/pull/41559) merged on May 5, 2023 &mdash; **Large:** [18 comments](https://github.com/flutter/engine/pull/41559) over 1 week, 296 additions and 240 deletions in 25 files</sub>
    <sub>Reviewed by: [Loïc Sharma](https://github.com/loic-sharma), [Michael Goderbauer](https://github.com/goderbauer), [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Add relative path support for malioc_diff.
    <sub>[#41703](https://github.com/flutter/engine/pull/41703) merged on May 3, 2023 &mdash; **Small:** [12 comments](https://github.com/flutter/engine/pull/41703) over 7 hours, 39 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Bruno Leroux](https://github.com/bleroux)** &mdash; Web - Fix selection jump on Chrome for Android
    <sub>[#41202](https://github.com/flutter/engine/pull/41202) merged on May 2, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/engine/pull/41202) over 2 weeks, 61 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Mouad Debbar](https://github.com/mdebbar)</sub>
...
* **[Dan Field](https://github.com/dnfield)** &mdash; Disable flaky tests on arm64
    <sub>[#41740](https://github.com/flutter/engine/pull/41740) merged on May 4, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41740) over 37 minutes, 6 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman)</sub>

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Roll buildroot to 05ec9f7124191c7ba354521f3ffd34b09af872e7
    <sub>[#41736](https://github.com/flutter/engine/pull/41736) merged on May 4, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41736) over 2 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] check if path is Rect/RRect/Oval
    <sub>[#41744](https://github.com/flutter/engine/pull/41744) merged on May 4, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41744) over 49 minutes, 14 additions and 1 deletion in 1 file</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] remove SDF code paths.
    <sub>[#41754](https://github.com/flutter/engine/pull/41754) merged on May 5, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41754) over 1 day, 11 additions and 214 deletions in 7 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Roll impeller-cmake-example to 270e648f8c00aa900d2d16ef8a347938652d17fb
    <sub>[#41758](https://github.com/flutter/engine/pull/41758) merged on May 5, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41758) over 18 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; [Impeller] Do not free a Vulkan command buffer if its command pool has already been destroyed
    <sub>[#41761](https://github.com/flutter/engine/pull/41761) merged on May 5, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41761) over 16 hours, 7 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [gaaclarke](https://github.com/gaaclarke)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Replace legacy linux unopt with engine v2.
    <sub>[#41757](https://github.com/flutter/engine/pull/41757) merged on May 5, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41757) over 17 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Allow default out_dir for fuchsia symbols upload.
    <sub>[#41776](https://github.com/flutter/engine/pull/41776) merged on May 5, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41776) over 55 minutes, 23 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Tong Mu](https://github.com/dkwingsmt)** &mdash; [macOS] Change view ID's type to signed and a typedef
    <sub>[#41653](https://github.com/flutter/engine/pull/41653) merged on May 5, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41653) over 3 days, 47 additions and 36 deletions in 14 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub>

* **[陈昱](https://github.com/ksballetba)** &mdash; Close connection on keyboard close
    <sub>[#41500](https://github.com/flutter/engine/pull/41500) merged on May 5, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41500) over 1 week, 71 additions and 1 deletion in 4 files</sub>
    <sub>Reviewed by: [ksballetchan](https://github.com/ksballetchan), [Ann Marie Mossman](https://github.com/mossmana), [luckysmg](https://github.com/luckysmg)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate linux unopt to engine_v2.
    <sub>[#41658](https://github.com/flutter/engine/pull/41658) merged on May 4, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41658) over 2 days, 130 additions and 0 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Michael Ludwig](https://github.com/lhkbob)** &mdash; Add temporary staging GN arg for Skia roll
    <sub>[#41743](https://github.com/flutter/engine/pull/41743) merged on May 4, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41743) over 43 minutes, 1 addition and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Remove the DrawPaint->Clear optimization
    <sub>[#41711](https://github.com/flutter/engine/pull/41711) merged on May 4, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41711) over 3 hours, 0 additions and 22 deletions in 2 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Tong Mu](https://github.com/dkwingsmt)** &mdash; [macOS] Remove view ID from public 
    <sub>[#41712](https://github.com/flutter/engine/pull/41712) merged on May 3, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41712) over 1 hour, 10 additions and 26 deletions in 4 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Load instead of restore drawing for non-MSAA passes
    <sub>[#41676](https://github.com/flutter/engine/pull/41676) merged on May 3, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41676) over 22 hours, 25 additions and 11 deletions in 1 file</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate Linux Android AOT Engine to engine V2.
    <sub>[#41638](https://github.com/flutter/engine/pull/41638) merged on May 2, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41638) over 1 day, 13 additions and 6 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Improve null safety for color->css
    <sub>[#41699](https://github.com/flutter/engine/pull/41699) merged on May 3, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41699) over 3 hours, 44 additions and 49 deletions in 12 files</sub>
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman), [Yegor](https://github.com/yjbanov)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Use os_dimension in framework tests.
    <sub>[#41649](https://github.com/flutter/engine/pull/41649) merged on May 1, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41649) over 52 minutes, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>

* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Remove unused function parameter
    <sub>[#41700](https://github.com/flutter/engine/pull/41700) merged on May 3, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41700) over 2 hours, 0 additions and 4 deletions in 3 files</sub>
    <sub>Reviewed by: [htoor3](https://github.com/htoor3)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate Android Engine Debug to Engine V2.
    <sub>[#41687](https://github.com/flutter/engine/pull/41687) merged on May 3, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41687) over 12 hours, 11 additions and 5 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Kevin Lubick](https://github.com/kjlubick)** &mdash; Migrate SkSurface::getBackend* methods to static functions
    <sub>[#41693](https://github.com/flutter/engine/pull/41693) merged on May 3, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41693) over 3 hours, 12 additions and 9 deletions in 3 files</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>
...
* **[joshualitt](https://github.com/joshualitt)** &mdash; [web] Add `dart:js_interop_unsafe` to SDK.
    <sub>[#41591](https://github.com/flutter/engine/pull/41591) merged on May 3, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41591) over 4 days, 14 additions and 0 deletions in 4 files</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>
...
* **[Ian McKellar](https://github.com/ianloic)** &mdash; [fuchsia] fix run_integration_test.sh
    <sub>[#41668](https://github.com/flutter/engine/pull/41668) merged on May 2, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41668) over 7 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [David Worsham](https://github.com/arbreng)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate linux_host_engine to engine v2.
    <sub>[#41715](https://github.com/flutter/engine/pull/41715) merged on May 4, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41715) over 18 hours, 5 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[William Hesse](https://github.com/whesse)** &mdash; Forward fix for roll of Dart SDK to version with new checked-in SDK
    <sub>[#41634](https://github.com/flutter/engine/pull/41634) merged on May 1, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41634) over 2 hours, 2 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Ricardo Amador](https://github.com/ricardoamador)</sub>

* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Revert "Skwasm Font Loading"
    <sub>[#41750](https://github.com/flutter/engine/pull/41750) merged on May 4, 2023 &mdash; **Extra large:** [0 comments](https://github.com/flutter/engine/pull/41750) over 47 minutes, 913 additions and 1401 deletions in 117 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[Greg Spencer](https://github.com/gspencergoog)** &mdash; Determine lifecycle by looking at window focus also
    <sub>[#41094](https://github.com/flutter/engine/pull/41094) merged on April 28, 2023 &mdash; **Medium:** [69 comments](https://github.com/flutter/engine/pull/41094) over 2 weeks, 469 additions and 31 deletions in 16 files</sub>
    <sub>Reviewed by: [Greg Price](https://github.com/gnprice), [xster](https://github.com/xster), [Ari Weiland](https://github.com/math1man), [Reid Baker](https://github.com/reidbaker)</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] partial repaint for Impeller/iOS.
    ...
    <sub>Reviewed by: [Matej Knopp](https://github.com/knopp), [Dan Field](https://github.com/dnfield)</sub>
...
* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] Fixed blit command missing tracking and added mock vulkan for tests
    <sub>[#41408](https://github.com/flutter/engine/pull/41408) merged on April 25, 2023 &mdash; **Medium:** [5 comments](https://github.com/flutter/engine/pull/41408) over 3 days, 431 additions and 1 deletion in 9 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; Made sure not to turn on wide gamut support without impeller.
    <sub>[#41460](https://github.com/flutter/engine/pull/41460) merged on April 25, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41460) over 1 day, 48 additions and 15 deletions in 6 files</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman), [Dan Field](https://github.com/dnfield)</sub>

* **[Dan Field](https://github.com/dnfield)** &mdash; Roll vulkan-deps and vs_toolchain
    <sub>[#41455](https://github.com/flutter/engine/pull/41455) merged on April 26, 2023 &mdash; **Large:** [8 comments](https://github.com/flutter/engine/pull/41455) over 1 day, 337 additions and 216 deletions in 3 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] Use a device buffer for SkBitmap allocation, use Linear texture on Metal backend.
    <sub>[#41374](https://github.com/flutter/engine/pull/41374) merged on April 26, 2023 &mdash; **Medium:** [28 comments](https://github.com/flutter/engine/pull/41374) over 6 days, 275 additions and 85 deletions in 14 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield), [gaaclarke](https://github.com/gaaclarke)</sub>

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] removed collisions of dead command pools between tests.
    <sub>[#41490](https://github.com/flutter/engine/pull/41490) merged on April 26, 2023 &mdash; **Small:** [11 comments](https://github.com/flutter/engine/pull/41490) over 20 hours, 19 additions and 5 deletions in 3 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Chris Yang](https://github.com/cyanglaz)** &mdash; [platform_view] Only dispose view when it is removed from the composition order
    <sub>[#41521](https://github.com/flutter/engine/pull/41521) merged on April 28, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41521) over 1 day, 116 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [damien saint macary](https://github.com/saintmac-google), [hellohuanlin](https://github.com/hellohuanlin)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Download and use the goma client from cipd
    <sub>[#41488](https://github.com/flutter/engine/pull/41488) merged on April 26, 2023 &mdash; **Small:** [14 comments](https://github.com/flutter/engine/pull/41488) over 23 hours, 101 additions and 3 deletions in 2 files</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield), [godofredoc](https://github.com/godofredoc)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Double zip FlutterMacOS.dSYM.zip.
    <sub>[#41425](https://github.com/flutter/engine/pull/41425) merged on April 25, 2023 &mdash; **Small:** [19 comments](https://github.com/flutter/engine/pull/41425) over 3 days, 36 additions and 17 deletions in 1 file</sub>
    <sub>Reviewed by: [Xilai Zhang](https://github.com/XilaiZhang)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Always enable validation for goldens
    <sub>[#41574](https://github.com/flutter/engine/pull/41574) merged on April 28, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41574) over 11 hours, 11 additions and 2 deletions in 3 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Kevin Lubick](https://github.com/kjlubick)** &mdash; Replace deprecated and internal Skia EncodedImage calls with public versions
    <sub>[#41368](https://github.com/flutter/engine/pull/41368) merged on April 28, 2023 &mdash; **Small:** [11 comments](https://github.com/flutter/engine/pull/41368) over 1 week, 88 additions and 29 deletions in 4 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Dan Field](https://github.com/dnfield)</sub>

* **[M-A](https://github.com/maruel)** &mdash; fuchsia: do not read version_history.json
    <sub>[#41585](https://github.com/flutter/engine/pull/41585) merged on April 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41585) over 1 hour, 1 addition and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Exclude Skia's Vello directory from the license crawl
    <sub>[#41617](https://github.com/flutter/engine/pull/41617) merged on April 29, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41617) over 1 hour, 2 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; Updated todo with github issue link
    <sub>[#41517](https://github.com/flutter/engine/pull/41517) merged on April 26, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41517) over 2 hours, 3 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Dan Field](https://github.com/dnfield)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Roll buildroot to 5708f2051772fd02c949e5dc9397e54f8c7a4478
    <sub>[#41540](https://github.com/flutter/engine/pull/41540) merged on April 27, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41540) over 44 minutes, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Manual clang roll to 5344d8e10bb7d8672d4bfae8adb010465470d51b
    <sub>[#41520](https://github.com/flutter/engine/pull/41520) merged on April 26, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41520) over 1 hour, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; Manual roll of Dart SDK from e8b86b073413 to 823a69e2a34d
    <sub>[#41614](https://github.com/flutter/engine/pull/41614) merged on April 29, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41614) over 1 hour, 4 additions and 4 deletions in 3 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Loïc Sharma](https://github.com/loic-sharma)** &mdash; Remove single view assumption from pointer events
    <sub>[#41602](https://github.com/flutter/engine/pull/41602) merged on April 29, 2023 &mdash; **Small:** [7 comments](https://github.com/flutter/engine/pull/41602) over 4 hours, 98 additions and 21 deletions in 7 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken), [Tong Mu](https://github.com/dkwingsmt), [Greg Spencer](https://github.com/gspencergoog)</sub>

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; [Impeller] Ensure that embedded blobs are placed at aligned addresses.
    <sub>[#41526](https://github.com/flutter/engine/pull/41526) merged on April 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41526) over 2 days, 7 additions and 4 deletions in 2 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Increase timeout for clang-tidy on mac
    <sub>[#41588](https://github.com/flutter/engine/pull/41588) merged on April 28, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41588) over 59 minutes, 2 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Jason Simmons](https://github.com/jason-simmons)</sub>

* **[M-A](https://github.com/maruel)** &mdash; Roll buildroot to c96c9d4641714301fab450a5f3b0f3c42712e1e3
    <sub>[#41589](https://github.com/flutter/engine/pull/41589) merged on April 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41589) over 1 hour, 1 addition and 1 deletion in 1 file</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] allow shader read for root resolve texture
    <sub>[#41543](https://github.com/flutter/engine/pull/41543) merged on April 27, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41543) over 1 hour, 2 additions and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Remove destructive blend mode check from Contents::ShouldRender
    <sub>[#41600](https://github.com/flutter/engine/pull/41600) merged on April 29, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41600) over 2 hours, 15 additions and 4 deletions in 3 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate desktop artifacts to engine v2.
    <sub>[#41599](https://github.com/flutter/engine/pull/41599) merged on April 28, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41599) over 46 minutes, 6 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken), [Zachary Anderson](https://github.com/zanderso)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate Linux Arm Host Engine to engine v2.
    <sub>[#41555](https://github.com/flutter/engine/pull/41555) merged on April 28, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41555) over 21 hours, 7 additions and 3 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] iOS/macOS: Only wait for command scheduling prior to present (redux)
    <sub>[#41501](https://github.com/flutter/engine/pull/41501) merged on April 26, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/engine/pull/41501) over 14 hours, 32 additions and 27 deletions in 6 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; Revert "Reland: [Impeller] Use a device buffer for SkBitmap allocation, use Linear texture on Metal backend. "
    <sub>[#41567](https://github.com/flutter/engine/pull/41567) merged on April 28, 2023 &mdash; **Medium:** [3 comments](https://github.com/flutter/engine/pull/41567) over 2 hours, 85 additions and 287 deletions in 16 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[Jesse Seales](https://github.com/sealesj)** &mdash; Refactor vuln scan into separate yaml
    <sub>[#41528](https://github.com/flutter/engine/pull/41528) merged on April 27, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41528) over 19 hours, 9 additions and 55 deletions in 2 files</sub>
    <sub>Reviewed by: [godofredoc](https://github.com/godofredoc)</sub>
...
* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Coerce opaque ColorSourceContents to Source
    <sub>[#41525](https://github.com/flutter/engine/pull/41525) merged on April 26, 2023 &mdash; **Small:** [10 comments](https://github.com/flutter/engine/pull/41525) over 3 hours, 226 additions and 6 deletions in 23 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate Windows AOT Engine to Engine V2.
    <sub>[#41515](https://github.com/flutter/engine/pull/41515) merged on April 26, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41515) over 2 hours, 13 additions and 6 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Store the root stencil on iOS
    <sub>[#41509](https://github.com/flutter/engine/pull/41509) merged on April 26, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41509) over 8 hours, 72 additions and 59 deletions in 5 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Manage the onscreen stencil in EntityPass
    <sub>[#41563](https://github.com/flutter/engine/pull/41563) merged on April 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41563) over 5 hours, 68 additions and 76 deletions in 4 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[godofredoc](https://github.com/godofredoc)** &mdash; [Cleanup] remove type=local from local test/generators.
    <sub>[#41465](https://github.com/flutter/engine/pull/41465) merged on April 25, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41465) over 3 hours, 15 additions and 30 deletions in 5 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Xilai Zhang](https://github.com/XilaiZhang)** &mdash; [codesign] Add pinned xcode version as property to mac android aot engine
    <sub>[#41518](https://github.com/flutter/engine/pull/41518) merged on April 26, 2023 &mdash; **Small:** [7 comments](https://github.com/flutter/engine/pull/41518) over 4 hours, 30 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [godofredoc](https://github.com/godofredoc)</sub>

* **[Jia Hao](https://github.com/jiahaog)** &mdash; Log dlopen errors in opt builds
    <sub>[#41477](https://github.com/flutter/engine/pull/41477) merged on April 26, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41477) over 23 hours, 4 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Revert "Replace deprecated and internal Skia EncodedImage calls with public versions"
    <sub>[#41595](https://github.com/flutter/engine/pull/41595) merged on April 28, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41595) over 39 minutes, 29 additions and 88 deletions in 4 files</sub>
...
* **[Akash Khunt](https://github.com/bastionkid)** &mdash; null check added to avoid NPE while calling FlutterView.detachFromFlutterEngine()
    <sub>[#41082](https://github.com/flutter/engine/pull/41082) merged on April 17, 2023 &mdash; **Small:** [13 comments](https://github.com/flutter/engine/pull/41082) over 6 days, 7 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Ian Hickson](https://github.com/Hixie), [Reid Baker](https://github.com/reidbaker), [Dan Field](https://github.com/dnfield), [gmackall](https://github.com/gmackall)</sub>
...
* **[Loïc Sharma](https://github.com/loic-sharma)** &mdash; [Windows] Don't block raster thread until v-blank
    <sub>[#41231](https://github.com/flutter/engine/pull/41231) merged on April 21, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41231) over 5 days, 214 additions and 25 deletions in 13 files</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [impeller] convert src over to src for solid color
    <sub>[#41351](https://github.com/flutter/engine/pull/41351) merged on April 20, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41351) over 1 hour, 32 additions and 0 deletions in 3 files</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>
...
* **[Mouad Debbar](https://github.com/mdebbar)** &mdash; [web] Remove non-ShadowDom mode
    <sub>[#39915](https://github.com/flutter/engine/pull/39915) merged on April 19, 2023 &mdash; **Large:** [11 comments](https://github.com/flutter/engine/pull/39915) over 1 month, 361 additions and 626 deletions in 10 files</sub>
    <sub>Reviewed by: [David Iglesias](https://github.com/ditman)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Remove glyph pixel rounding during text frame conversion
...
* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Fix division by zero for transparent shadows
    <sub>[#41391](https://github.com/flutter/engine/pull/41391) merged on April 21, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41391) over 8 hours, 44 additions and 1 deletion in 4 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Fix transform regressions for chained filters
    <sub>[#41332](https://github.com/flutter/engine/pull/41332) merged on April 19, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41332) over 10 hours, 136 additions and 139 deletions in 12 files</sub>
...
* **[David Iglesias](https://github.com/ditman)** &mdash; [web] Fix HashUrlStrategy.addPopStateListener
    <sub>[#41384](https://github.com/flutter/engine/pull/41384) merged on April 21, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41384) over 15 hours, 52 additions and 3 deletions in 2 files</sub>
    <sub>Reviewed by: [Mouad Debbar](https://github.com/mdebbar), [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>

* **[maRci002](https://github.com/maRci002)** &mdash; [web] change status bar color based on SystemUiOverlayStyle
    <sub>[#40599](https://github.com/flutter/engine/pull/40599) merged on April 20, 2023 &mdash; **Medium:** [21 comments](https://github.com/flutter/engine/pull/40599) over 3 weeks, 210 additions and 102 deletions in 6 files</sub>
...
* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [impeller] fixed flake where blit wasn't tracking its texture
    <sub>[#41347](https://github.com/flutter/engine/pull/41347) merged on April 21, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41347) over 1 day, 12 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub>

* **[Bruno Leroux](https://github.com/bleroux)** &mdash; [macOS] Fix Ctrl+Tab is broken
    <sub>[#40706](https://github.com/flutter/engine/pull/40706) merged on April 18, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/40706) over 3 weeks, 102 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Justin McCandless](https://github.com/justinmc)</sub>

* **[Dan Field](https://github.com/dnfield)** &mdash; [Impeller] Gpu model information to Skia gold
    <sub>[#41216](https://github.com/flutter/engine/pull/41216) merged on April 18, 2023 &mdash; **Small:** [9 comments](https://github.com/flutter/engine/pull/41216) over 4 days, 107 additions and 25 deletions in 15 files</sub>
    <sub>Reviewed by: [Kate Lovett](https://github.com/Piinks), [gaaclarke](https://github.com/gaaclarke), [Mouad Debbar](https://github.com/mdebbar)</sub>

* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [impeller] added moltenvk notice
    <sub>[#41317](https://github.com/flutter/engine/pull/41317) merged on April 19, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41317) over 16 hours, 7 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>

* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; [Impeller] Change the default color format for the GLES backend to RGBA
    <sub>[#41342](https://github.com/flutter/engine/pull/41342) merged on April 20, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41342) over 21 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub>

* **[Yegor](https://github.com/yjbanov)** &mdash; [web:canvaskit] remove unnecessary instrumentation from picture
    <sub>[#41313](https://github.com/flutter/engine/pull/41313) merged on April 18, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41313) over 1 hour, 39 additions and 4 deletions in 2 files</sub>
    <sub>Reviewed by: [Harry Terkelsen](https://github.com/hterkelsen)</sub>

* **[Jenn Magder](https://github.com/jmagman)** &mdash; Run mac unopt arm builds with arm toolchain
    <sub>[#41353](https://github.com/flutter/engine/pull/41353) merged on April 21, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41353) over 22 hours, 2 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Chinmay Garde](https://github.com/chinmaygarde)** &mdash; [Impeller] Make //impeller/display_list TU naming consistent.
    <sub>[#41174](https://github.com/flutter/engine/pull/41174) merged on April 19, 2023 &mdash; **Medium:** [8 comments](https://github.com/flutter/engine/pull/41174) over 5 days, 190 additions and 195 deletions in 19 files</sub>
...
* **[Jason Simmons](https://github.com/jason-simmons)** &mdash; [Impeller] Add a CommandBuffer::WaitUntilScheduled API
    <sub>[#41303](https://github.com/flutter/engine/pull/41303) merged on April 21, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41303) over 3 days, 32 additions and 0 deletions in 11 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub>
...
* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Roll impeller-cmake-example to 58042bb24833a3cbd615ad082b1d17daef42d097
    <sub>[#41280](https://github.com/flutter/engine/pull/41280) merged on April 17, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41280) over 2 hours, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>

* **[Jenn Magder](https://github.com/jmagman)** &mdash; Remove 'Mac mac_unopt' in favor of Linux
    <sub>[#41226](https://github.com/flutter/engine/pull/41226) merged on April 17, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41226) over 2 days, 10 additions and 8 deletions in 2 files</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>

* **[Chinmay Garde](https://github.com/chinmaygarde)** &mdash; [Impeller] Add debug ToString methods to render targets.
    <sub>[#41221](https://github.com/flutter/engine/pull/41221) merged on April 17, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/engine/pull/41221) over 3 days, 202 additions and 7 deletions in 11 files</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero), [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[Alexander Aprelev](https://github.com/aam)** &mdash; Roll dart, zlib, emscripten, tweak license script for rolled zlib
    <sub>[#41299](https://github.com/flutter/engine/pull/41299) merged on April 19, 2023 &mdash; **Medium:** [7 comments](https://github.com/flutter/engine/pull/41299) over 12 hours, 207 additions and 158 deletions in 8 files</sub>
    <sub>Reviewed by: [Ian Hickson](https://github.com/Hixie), [Zachary Anderson](https://github.com/zanderso), [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>
...
* **[gaaclarke](https://github.com/gaaclarke)** &mdash; [Impeller] Turned off the TextRotated golden test again
    <sub>[#41399](https://github.com/flutter/engine/pull/41399) merged on April 21, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41399) over 1 hour, 3 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Always use BGRA10_XR for wide gamut
    <sub>[#41385](https://github.com/flutter/engine/pull/41385) merged on April 21, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41385) over 6 hours, 2 additions and 15 deletions in 2 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>

* **[keyonghan](https://github.com/keyonghan)** &mdash; Update xcode to 14c18
    <sub>[#41370](https://github.com/flutter/engine/pull/41370) merged on April 21, 2023 &mdash; **Small:** [8 comments](https://github.com/flutter/engine/pull/41370) over 12 hours, 13 additions and 9 deletions in 3 files</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman)</sub>

* **[Greg Spencer](https://github.com/gspencergoog)** &mdash; Some minor doc typo and diagnostic fixes.
    <sub>[#40982](https://github.com/flutter/engine/pull/40982) merged on April 18, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/40982) over 1 week, 16 additions and 15 deletions in 6 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub>
...
* **[yaakovschectman](https://github.com/yaakovschectman)** &mdash; Move ownership of `AccessibilityBridgeWindows` to `FlutterWindowsView`
    <sub>[#41308](https://github.com/flutter/engine/pull/41308) merged on April 20, 2023 &mdash; **Small:** [7 comments](https://github.com/flutter/engine/pull/41308) over 2 days, 72 additions and 61 deletions in 7 files</sub>
    <sub>Reviewed by: [Loïc Sharma](https://github.com/loic-sharma), [Tong Mu](https://github.com/dkwingsmt)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; re-land "Migrate mac_host_engine to engine v2 builds." (#41233)"
    <sub>[#41323](https://github.com/flutter/engine/pull/41323) merged on April 20, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41323) over 1 day, 27 additions and 13 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[joshualitt](https://github.com/joshualitt)** &mdash; [web] Fix trivial type issue.
    <sub>[#40956](https://github.com/flutter/engine/pull/40956) merged on April 19, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/40956) over 1 week, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [Jackson Gardner](https://github.com/eyebrowsoffire)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Double zip FlutterMacOS.framework.zip.
    <sub>[#41306](https://github.com/flutter/engine/pull/41306) merged on April 18, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41306) over 3 hours, 13 additions and 0 deletions in 1 file</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman), [Christopher Fujino](https://github.com/christopherfujino)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; Add missing header guards
    <sub>[#41322](https://github.com/flutter/engine/pull/41322) merged on April 19, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41322) over 16 hours, 80 additions and 6 deletions in 21 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde), [Zachary Anderson](https://github.com/zanderso)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Migrate android AOT to engine_v2.
    <sub>[#41229](https://github.com/flutter/engine/pull/41229) merged on April 18, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/engine/pull/41229) over 3 days, 13 additions and 6 deletions in 2 files</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Comprehensively label snapshots
    <sub>[#41325](https://github.com/flutter/engine/pull/41325) merged on April 19, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/engine/pull/41325) over 12 hours, 80 additions and 39 deletions in 28 files</sub>
    <sub>Reviewed by: [Chinmay Garde](https://github.com/chinmaygarde)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Upload windows arm artifacts to production bucket.
    <sub>[#41324](https://github.com/flutter/engine/pull/41324) merged on April 20, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41324) over 1 day, 6 additions and 3 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>

* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Add buffer-to-texture blit capability check; fix GL+VK playgrounds on macOS
    <sub>[#41320](https://github.com/flutter/engine/pull/41320) merged on April 19, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41320) over 51 minutes, 93 additions and 63 deletions in 7 files</sub>
    <sub>Reviewed by: [Jonah Williams](https://github.com/jonahwilliams)</sub>
...
* **[skia-flutter-autoroll](https://github.com/skia-flutter-autoroll)** &mdash; Manual roll Skia from d9e216e62223 to 5bd4bdc0d8e2 (12 revisions)
    <sub>[#41286](https://github.com/flutter/engine/pull/41286) merged on April 18, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41286) over 14 hours, 4 additions and 2 deletions in 2 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[Zachary Anderson](https://github.com/zanderso)** &mdash; Revert "[Impeller] Turned on wide gamut support by default."
    <sub>[#41382](https://github.com/flutter/engine/pull/41382) merged on April 21, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/engine/pull/41382) over 1 hour, 3 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>
...
* **[godofredoc](https://github.com/godofredoc)** &mdash; Revert "Upload windows arm artifacts to production bucket."
    <sub>[#41372](https://github.com/flutter/engine/pull/41372) merged on April 20, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41372) over 1 minute, 3 additions and 6 deletions in 1 file</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Revert "Reland  "Migrate mac_host_engine to engine v2 builds.""
    <sub>[#41284](https://github.com/flutter/engine/pull/41284) merged on April 18, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41284) over 59 seconds, 13 additions and 27 deletions in 2 files</sub>
    <sub>Reviewed by: [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>

* **[Jackson Gardner](https://github.com/eyebrowsoffire)** &mdash; Reland ui_web files in sky_engine
    <sub>[#41169](https://github.com/flutter/engine/pull/41169) merged on April 17, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/engine/pull/41169) over 4 days, 102 additions and 74 deletions in 5 files</sub>
    <sub>Reviewed by: [Yegor](https://github.com/yjbanov)</sub>
...
* **[Brandon DeRosier](https://github.com/bdero)** &mdash; [Impeller] Add offscreen texture checkerboarding
    <sub>[#41199](https://github.com/flutter/engine/pull/41199) merged on April 16, 2023 &mdash; **Large:** [18 comments](https://github.com/flutter/engine/pull/41199) over 1 day, 646 additions and 23 deletions in 19 files</sub>
...
* **[Jonah Williams](https://github.com/jonahwilliams)** &mdash; [Impeller] add a generic porter duff blend foreground shader.
    <sub>[#41098](https://github.com/flutter/engine/pull/41098) merged on April 15, 2023 &mdash; **Large:** [10 comments](https://github.com/flutter/engine/pull/41098) over 3 days, 500 additions and 24 deletions in 12 files</sub>
    <sub>Reviewed by: [Brandon DeRosier](https://github.com/bdero)</sub>

* **[Jenn Magder](https://github.com/jmagman)** &mdash; Remove jazzy and Xcode properties from impeller-cmake-example builder
    <sub>[#41222](https://github.com/flutter/engine/pull/41222) merged on April 15, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/engine/pull/41222) over 6 hours, 0 additions and 6 deletions in 1 file</sub>
    <sub>Reviewed by: [Zachary Anderson](https://github.com/zanderso)</sub>
...
* **[godofredoc](https://github.com/godofredoc)** &mdash; Do not run clang tidy on recipes cq.
    <sub>[#41227](https://github.com/flutter/engine/pull/41227) merged on April 15, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41227) over 44 minutes, 0 additions and 4 deletions in 1 file</sub>
    <sub>Reviewed by: [keyonghan](https://github.com/keyonghan)</sub>

* **[godofredoc](https://github.com/godofredoc)** &mdash; Revert "Migrate mac_host_engine to engine v2 builds."
    <sub>[#41233](https://github.com/flutter/engine/pull/41233) merged on April 15, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/engine/pull/41233) over 1 minute, 13 additions and 27 deletions in 2 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken), [Flutter GitHub Bot](https://github.com/fluttergithubbot)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [video_player] Fix Android lints
    <sub>[#3886](https://github.com/flutter/packages/pull/3886) merged on May 4, 2023 &mdash; **Extra large:** [3 comments](https://github.com/flutter/packages/pull/3886) over 1 day, 495 additions and 1127 deletions in 11 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>

* **[Maurice Parrish](https://github.com/bparrishMines)** &mdash; [webview_flutter_android] Adds support to accept third party cookies
    <sub>[#3834](https://github.com/flutter/packages/pull/3834) merged on May 2, 2023 &mdash; **Extra large:** [5 comments](https://github.com/flutter/packages/pull/3834) over 5 days, 1386 additions and 184 deletions in 20 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [file_selector] Remove uses of `macUTIs`
    <sub>[#3859](https://github.com/flutter/packages/pull/3859) merged on May 1, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/3859) over 2 hours, 63 additions and 65 deletions in 18 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [file_selector] Add `getDirectoryPaths`
    <sub>[#3871](https://github.com/flutter/packages/pull/3871) merged on May 4, 2023 &mdash; **Small:** [4 comments](https://github.com/flutter/packages/pull/3871) over 3 days, 206 additions and 21 deletions in 7 files</sub>
    <sub>Reviewed by: [Chris Bracken](https://github.com/cbracken)</sub>

* **[Tarrin Neal](https://github.com/tarrinneal)** &mdash; tree fix
    <sub>[#3910](https://github.com/flutter/packages/pull/3910) merged on May 5, 2023 &mdash; **Small:** [2 comments](https://github.com/flutter/packages/pull/3910) over 6 hours, 5 additions and 1 deletion in 2 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>

* **[Tarrin Neal](https://github.com/tarrinneal)** &mdash; manual roll and fix
    <sub>[#3903](https://github.com/flutter/packages/pull/3903) merged on May 5, 2023 &mdash; **Small:** [6 comments](https://github.com/flutter/packages/pull/3903) over 23 hours, 23 additions and 77 deletions in 4 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Maurice Parrish](https://github.com/bparrishMines)</sub>

* **[Jonathan](https://github.com/TheUltimateOptimist)** &mdash; [go_router_builder] fixed typo in README
    <sub>[#3835](https://github.com/flutter/packages/pull/3835) merged on May 4, 2023 &mdash; **Small:** [7 comments](https://github.com/flutter/packages/pull/3835) over 1 week, 1 addition and 1 deletion in 1 file</sub>
    <sub>Reviewed by: [chunhtai](https://github.com/chunhtai), [hangyu](https://github.com/hangyujin)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [quick_actions] Fix Android lint issues
    <sub>[#3885](https://github.com/flutter/packages/pull/3885) merged on May 4, 2023 &mdash; **Small:** [5 comments](https://github.com/flutter/packages/pull/3885) over 1 day, 21 additions and 117 deletions in 6 files</sub>
    <sub>Reviewed by: [Camille Simon](https://github.com/camsim99)</sub>

* **[Victoria Ashworth](https://github.com/vashworth)** &mdash; Update Cirrus to Xcode 14.3
    <sub>[#3890](https://github.com/flutter/packages/pull/3890) merged on May 3, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3890) over 18 hours, 2 additions and 2 deletions in 1 file</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [file_selector] Deprecates `macUTIs`
    <sub>[#3888](https://github.com/flutter/packages/pull/3888) merged on May 3, 2023 &mdash; **Small:** [0 comments](https://github.com/flutter/packages/pull/3888) over 18 hours, 93 additions and 79 deletions in 5 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>

* **[Maurice Parrish](https://github.com/bparrishMines)** &mdash; [webview_flutter_wkwebview] Fixes an exception caused by the `onUrlChange` callback returning a null url
    <sub>[#3848](https://github.com/flutter/packages/pull/3848) merged on May 2, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3848) over 3 days, 57 additions and 3 deletions in 4 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>
...
* **[Victoria Ashworth](https://github.com/vashworth)** &mdash; [video_player, google_sign_in] Updates functions without a prototype to avoid deprecation warning
    <sub>[#3873](https://github.com/flutter/packages/pull/3873) merged on May 1, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/3873) over 28 minutes, 12 additions and 4 deletions in 6 files</sub>
    <sub>Reviewed by: [Jenn Magder](https://github.com/jmagman)</sub>

* **[Reid Baker](https://github.com/reidbaker)** &mdash; I122213 update non examples
    <sub>[#3846](https://github.com/flutter/packages/pull/3846) merged on May 1, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/3846) over 2 days, 6 additions and 5 deletions in 5 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[chunhtai](https://github.com/chunhtai)** &mdash; [go_router] Cleans up route match API and introduces dart fix
    <sub>[#3819](https://github.com/flutter/packages/pull/3819) merged on April 29, 2023 &mdash; **Large:** [24 comments](https://github.com/flutter/packages/pull/3819) over 3 days, 966 additions and 448 deletions in 40 files</sub>
...
* **[Reid Baker](https://github.com/reidbaker)** &mdash; [various] update agp and gradle for all examples in packages
    ...
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Greg Spencer](https://github.com/gspencergoog), [gmackall](https://github.com/gmackall), [Camille Simon](https://github.com/camsim99), [chunhtai](https://github.com/chunhtai), and [1 other](https://github.com/flutter/packages/pull/3822)</sub>
...
* **[Jeroen Weener](https://github.com/JeroenWeener)** &mdash; [image_picker] Move I/O operations to a separate thread
    ...
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal), [stuartmorgan](https://github.com/stuartmorgan), [Reid Baker](https://github.com/reidbaker)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [tool] Move Android lint checks
    <sub>[#3816](https://github.com/flutter/packages/pull/3816) merged on April 26, 2023 &mdash; **Large:** [5 comments](https://github.com/flutter/packages/pull/3816) over 9 hours, 370 additions and 253 deletions in 9 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>

* **[Chris Yang](https://github.com/cyanglaz)** &mdash; [auick_action_ios] Retries multiple times to not fail ci when there is a flake
    <sub>[#3823](https://github.com/flutter/packages/pull/3823) merged on April 27, 2023 &mdash; **Small:** [7 comments](https://github.com/flutter/packages/pull/3823) over 1 day, 50 additions and 24 deletions in 1 file</sub>
    <sub>Reviewed by: [hellohuanlin](https://github.com/hellohuanlin)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [various] Set cmake_policy versions
    <sub>[#3828](https://github.com/flutter/packages/pull/3828) merged on April 26, 2023 &mdash; **Small:** [3 comments](https://github.com/flutter/packages/pull/3828) over 49 minutes, 39 additions and 8 deletions in 19 files</sub>
    <sub>Reviewed by: [yaakovschectman](https://github.com/yaakovschectman)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [pigeon] Reland: Add an initial example app
    <sub>[#3832](https://github.com/flutter/packages/pull/3832) merged on April 28, 2023 &mdash; **Extra large:** [1 comment](https://github.com/flutter/packages/pull/3832) over 1 day, 4360 additions and 0 deletions in 117 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[Maurice Parrish](https://github.com/bparrishMines)** &mdash; [camera_android] Fix Android lint warnings 
    <sub>[#3716](https://github.com/flutter/packages/pull/3716) merged on April 21, 2023 &mdash; **Extra large:** [17 comments](https://github.com/flutter/packages/pull/3716) over 1 week, 391 additions and 3276 deletions in 41 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan), [Camille Simon](https://github.com/camsim99)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [pigeon] Add an initial example app
    <sub>[#3761](https://github.com/flutter/packages/pull/3761) merged on April 20, 2023 &mdash; **Extra large:** [11 comments](https://github.com/flutter/packages/pull/3761) over 22 hours, 4360 additions and 0 deletions in 117 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [google_sign_in] Fix Android Java warnings
    <sub>[#3762](https://github.com/flutter/packages/pull/3762) merged on April 21, 2023 &mdash; **Large:** [5 comments](https://github.com/flutter/packages/pull/3762) over 2 days, 150 additions and 889 deletions in 10 files</sub>
...
* **[dependabot](https://github.com/apps/dependabot)** &mdash; [webview]: Bump com.android.tools.build:gradle from 7.2.2 to 8.0.0 in /packages/webview_flutter/webview_flutter_android/android
    <sub>[#3739](https://github.com/flutter/packages/pull/3739) merged on April 18, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3739) over 1 day, 6 additions and 2 deletions in 3 files</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [local_auth] Convert Android to Pigeon
    <sub>[#3748](https://github.com/flutter/packages/pull/3748) merged on April 18, 2023 &mdash; **Extra large:** [5 comments](https://github.com/flutter/packages/pull/3748) over 21 hours, 2051 additions and 861 deletions in 16 files</sub>
    <sub>Reviewed by: [Reid Baker](https://github.com/reidbaker)</sub>
...
* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [local_auth] Fix enum return on Android
    <sub>[#3780](https://github.com/flutter/packages/pull/3780) merged on April 21, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3780) over 1 day, 141 additions and 40 deletions in 10 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>

* **[stuartmorgan](https://github.com/stuartmorgan)** &mdash; [pigeon] Warn when trying to use enums in collections
    <sub>[#3782](https://github.com/flutter/packages/pull/3782) merged on April 21, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3782) over 1 day, 71 additions and 11 deletions in 14 files</sub>
    <sub>Reviewed by: [Tarrin Neal](https://github.com/tarrinneal)</sub>
...
* **[Tarrin Neal](https://github.com/tarrinneal)** &mdash; [Tool] [Code Excerpt] allow excerpts in example readme
    <sub>[#3758](https://github.com/flutter/packages/pull/3758) merged on April 19, 2023 &mdash; **Small:** [9 comments](https://github.com/flutter/packages/pull/3758) over 1 day, 81 additions and 1 deletion in 4 files</sub>
    <sub>Reviewed by: [stuartmorgan](https://github.com/stuartmorgan)</sub>

* **[chunhtai](https://github.com/chunhtai)** &mdash; [go_router] migrates test for route information.location deprecation
    <sub>[#3763](https://github.com/flutter/packages/pull/3763) merged on April 19, 2023 &mdash; **Small:** [1 comment](https://github.com/flutter/packages/pull/3763) over 48 minutes, 50 additions and 40 deletions in 1 file</sub>
